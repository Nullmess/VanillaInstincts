...
public final class ConfigSnapshot {
    ...
    private ConfigSnapshot(Builder builder) {
        profile = Objects.requireNonNullElse(builder.profile,
                GameplayProfile.BALANCED);
        minimumHostileDifficulty = Objects.requireNonNullElse(
                builder.minimumHostileDifficulty, DifficultyTier.EASY);
