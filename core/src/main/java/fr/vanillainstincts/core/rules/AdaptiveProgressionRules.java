...
public final class AdaptiveProgressionRules {
    ...
    public static double spawnChance(double normalChance,
        ...
        double multiplier = switch (tier) {
            case PEACEFUL -> PEACEFUL_CHANCE_MULTIPLIER;
            case EASY -> EASY_CHANCE_MULTIPLIER;
            case NORMAL -> NORMAL_CHANCE_MULTIPLIER;
            case HARD -> HARD_CHANCE_MULTIPLIER;
        };
    ...
    public static final double ZOMBIE_ANGLER_PULL_SPEED = 1.35D;
    public static final double ZOMBIE_ANGLER_PULL_LIFT = 0.52D;
