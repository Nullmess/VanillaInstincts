...
public final class AdaptiveEquipmentRules {
    ...
    public static int localLimit(Tier tier) {
        return switch (tier) {
            case IRON -> IRON_LOCAL_LIMIT;
            case DIAMOND -> DIAMOND_LOCAL_LIMIT;
            case NETHERITE -> NETHERITE_LOCAL_LIMIT;
        };
    }
    ...
    public static int maximumArmorPieces(Tier tier,
        ...
        return switch (tier) {
            case IRON -> switch (value) {
                case PEACEFUL -> 0;
                case EASY -> 2;
                case NORMAL -> 3;
                case HARD -> 4;
            };
            case DIAMOND -> switch (value) {
                case PEACEFUL -> 0;
                case EASY -> 1;
                case NORMAL -> 2;
                case HARD -> 3;
            };
            case NETHERITE -> switch (value) {
                case PEACEFUL -> 0;
                case EASY -> 1;
                case NORMAL -> 2;
                case HARD -> 3;
