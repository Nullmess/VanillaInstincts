...
public final class SpeciesRuntimeState {
    ...
    public void sampleCreeperMovement(Vec3d position, long gameTime,
        ...
        Vec3d previous = new Vec3d(creeperMovementX, creeperMovementY,
                creeperMovementZ);
    ...
    private void setCreeperMovementSample(Vec3d position, long gameTime) {
    ...
    private void sanitize(long gameTime) {
        if (!finite(new Vec3d(creeperMovementX, creeperMovementY,
                creeperMovementZ))) {
