...
public final class SpiderSurfaceNavigator {
    ...
    public static Optional<SpiderSurfacePath> plan(
            SpiderEntity spider, Vec3d destination, ServerWorld level, long gameTime) {
    ...
    public static boolean continuesToward(SpiderEntity spider, Vec3d destination,
                                          long gameTime) {
    ...
    private static boolean shouldUseSurfaceNavigation(
            SpiderEntity spider, Vec3d destination) {
        if (spider == null || destination == null) {
            return false;
        }
    ...
    private static Vec3d targetForActiveStep(SpiderEntity spider, ServerWorld level,
                                            ActivePath active,
    ...
    private static void moveToward(SpiderEntity spider, SpiderSurfaceNode node,
                                   Vec3d target) {
        Vec3d delta = target.subtract(spider.position());
        ...
        Vec3d current = spider.getDeltaMovement();
