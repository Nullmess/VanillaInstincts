 ...
 *
 * The list is deliberately explicit so a Minecraft update adding a new MobEntity
 * cannot silently claim complete vanilla coverage. Modded MobEntity subclasses use
...
public final class VanillaMobPossessionCatalog {
    ...
    public static boolean coversVanillaMob(MobEntity mob) {
        ResourceLocation id = Registry.ENTITY_TYPE.getKey(mob.getType());
    ...
    public static boolean isVanilla(MobEntity mob) {
        ResourceLocation id = Registry.ENTITY_TYPE.getKey(mob.getType());
        return id != null && "minecraft".equals(id.getNamespace());
    }

    public static String path(MobEntity mob) {
        ResourceLocation id = Registry.ENTITY_TYPE.getKey(mob.getType());
        return id == null ? "unknown" : id.getPath();
    }

    public static Movement movement(MobEntity mob) {
