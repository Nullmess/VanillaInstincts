...
public final class MissionZoglinTargetPolicy {
    ...
    public static boolean isMissionZoglin(
            MobEntity mob, NetherReinforcementState state) {
        return mob instanceof ZombiePigmanEntity
                && state != null
    ...
    public static boolean canAttackTarget(
        ...
        if (!(candidate instanceof ServerPlayerEntity)) {
            return false;
        } ServerPlayerEntity player = (ServerPlayerEntity) (candidate);
    ...
    public static boolean enforce(
            MobEntity mob, NetherReinforcementState state,
            ServerPlayerEntity aggressor, long gameTime) {
    ...
    public static boolean shouldBlockAttack(
        ...
        if (!(attacker instanceof ZombiePigmanEntity)
                || victim == null
                || !NetherReinforcementState.hasPersistentMission(((ZombiePigmanEntity) (attacker)))) {
            return false;
        } ZombiePigmanEntity zoglin = (ZombiePigmanEntity) (attacker);
