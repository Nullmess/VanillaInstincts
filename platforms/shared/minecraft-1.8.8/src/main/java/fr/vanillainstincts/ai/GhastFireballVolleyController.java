...
public final class GhastFireballVolleyController {
    ...
    public static void tickFireball(EntityFireball fireball,
        ...
        Entity source = level.getEntityFromUuid(fr.vanillainstincts.compat.Minecraft18NbtCompat.getUniqueId(ballData, SOURCE_GHAST));
        ...
        if (fr.vanillainstincts.compat.Minecraft18NbtCompat.hasUniqueId(ballData, TARGET_PLAYER)) {
            Entity target = level.getEntityFromUuid(fr.vanillainstincts.compat.Minecraft18NbtCompat.getUniqueId(ballData, TARGET_PLAYER));
        ...
        Vec3 toGhast = ghast.getPositionEyes(1.0F).subtract(fireball.getPositionVector());
    ...
    private static void returnToPlayer(EntityFireball fireball, EntityGhast ghast,
        ...
        Vec3 destination = predictedTarget(player, fireball.getPositionVector(), speed);
        Vec3 direction = destination.subtract(fireball.getPositionVector());
    ...
    private static EntityGhast nearestSourceGhast(EntityFireball fireball,
        ...
        for (EntityGhast candidate : level.getEntitiesWithinAABB(
                EntityGhast.class, fireball.getEntityBoundingBox().expand(16.0D, 16.0D, 16.0D),
