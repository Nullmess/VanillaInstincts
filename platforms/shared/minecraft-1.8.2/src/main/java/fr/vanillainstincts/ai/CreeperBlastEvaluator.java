...
public final class CreeperBlastEvaluator {
    ...
    public static double estimatedDamage(EntityCreeper creeper,
        ...
        Vec3 center =fr.vanillainstincts.compat.Minecraft112Compat.add(creeper.getPositionVector(), 0.0D,
                creeper.height * 0.5D, 0.0D);
        double distance = center.distanceTo(fr.vanillainstincts.compat.Minecraft110Compat.boxCenter(target.getEntityBoundingBox()));
