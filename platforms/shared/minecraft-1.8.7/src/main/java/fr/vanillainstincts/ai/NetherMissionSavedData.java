...
if (tag == null) return;
    ...
    private static void writeUuidLongMap(NBTTagCompound parent, String key,
        ...
        for (Map.Entry<UUID, Long> entry : values.entrySet()) {
            ...
            fr.vanillainstincts.compat.Minecraft18NbtCompat.setUniqueId(element, "id", entry.getKey());
    ...
    private static void readUuidLongMap(NBTTagCompound parent, String key,
        ...
        for (int index = 0; index < list.tagCount(); index++) {
            ...
            if (fr.vanillainstincts.compat.Minecraft18NbtCompat.hasUniqueId(element, "id")) {
                target.put(fr.vanillainstincts.compat.Minecraft18NbtCompat.getUniqueId(element, "id"),
    ...
    public static class VirtualExpeditionRecord {
        ...
        public NBTTagCompound save() {
            ...
            fr.vanillainstincts.compat.Minecraft18NbtCompat.setUniqueId(tag, "mission_id", missionId);
            fr.vanillainstincts.compat.Minecraft18NbtCompat.setUniqueId(tag, "aggressor_id", aggressorId);
            ...
            fr.vanillainstincts.compat.Minecraft18NbtCompat.setUniqueId(tag, "original_messenger_id", originalMessengerId);
        ...
        public static VirtualExpeditionRecord load(NBTTagCompound tag) {
            if (tag == null || !fr.vanillainstincts.compat.Minecraft18NbtCompat.hasUniqueId(tag, "mission_id")
                    || !fr.vanillainstincts.compat.Minecraft18NbtCompat.hasUniqueId(tag, "aggressor_id")
                    || !fr.vanillainstincts.compat.Minecraft18NbtCompat.hasUniqueId(tag, "original_messenger_id")) {
                return null;
            }
            ...
            return new VirtualExpeditionRecord(
                    fr.vanillainstincts.compat.Minecraft18NbtCompat.getUniqueId(tag, "mission_id"),
                    fr.vanillainstincts.compat.Minecraft18NbtCompat.getUniqueId(tag, "aggressor_id"),
                    kind,
                    ...
                    fr.vanillainstincts.compat.Minecraft18NbtCompat.getUniqueId(tag, "original_messenger_id"),
