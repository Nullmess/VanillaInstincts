...
public final class MobEcologyController {
    ...
    public static Optional<EcologyThreat> nearestAvoidedThreat(
        ...
        AxisAlignedBB area = animal.getEntityBoundingBox().expand(radius, radius, radius);
    ...
    public static Vec3 fleeDestination(EntityAnimal animal, EntityLivingBase threat) {
        ...
        Vec3 away = animal.getPositionVector().subtract(threat.getPositionVector());
        ...
        return animal.getPositionVector().add(fr.vanillainstincts.compat.Minecraft112Compat.scale(horizontal, 
