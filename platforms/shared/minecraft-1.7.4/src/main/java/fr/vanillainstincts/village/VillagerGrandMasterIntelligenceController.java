...
public final class VillagerGrandMasterIntelligenceController {
    ...
    public static boolean contribute(EntityVillager villager,
        ...
        Vec3 requested = fr.vanillainstincts.compat.Minecraft17Compat.position(mentor);
    ...
    private static void maintainMentor(EntityVillager mentor, WorldServer level,
        ...
        AxisAlignedBB area = fr.vanillainstincts.compat.Minecraft17Compat.boundingBox(mentor).expand(radius, radius, radius);
        List<EntityVillager> candidates = fr.vanillainstincts.compat.Minecraft112Compat.entitiesWithinAABB(level, EntityVillager.class,
    ...
    private static EntityVillager activeMentor(EntityVillager apprentice,
        ...
        Entity entity = fr.vanillainstincts.compat.Minecraft17Compat.getEntityFromUuid(level, mentorId);
