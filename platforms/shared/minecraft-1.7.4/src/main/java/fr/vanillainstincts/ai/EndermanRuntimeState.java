...
public final class EndermanRuntimeState {
    ...
    private UUID suspendedAngerTargetId;
    ...
    public void beginCarry(Entity cargo, EntityLivingBase objective,
    ...
    public void rememberSuspendedAnger(UUID targetId, int ticks) {
    ...
    public void setObjective(EntityLivingBase objective) {
    ...
    public UUID cargoId() { return cargoId; }
    public UUID objectiveId() { return objectiveId; }
    public long carryingSince() { return carryingSince; }
    public long releaseAt() { return releaseAt; }
    public UUID suspendedAngerTargetId() {
