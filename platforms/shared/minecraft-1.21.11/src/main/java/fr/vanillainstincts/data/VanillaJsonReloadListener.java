...
abstract class VanillaJsonReloadListener
    ...
    protected Map<Identifier, JsonElement> prepare(
        ...
        Map<Identifier, JsonElement> loaded = new LinkedHashMap<>();
    ...
    private static void loadResource(
            Map<Identifier, JsonElement> loaded,
            String prefix, Identifier resourceId, Resource resource) {
        ...
        Identifier logicalId = Identifier.fromNamespaceAndPath(
