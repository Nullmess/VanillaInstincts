...
public final class MobRunController {
    ...
    public static void setCombatSprint(MobEntity mob, boolean active) {
        ...
        ModifiableAttributeInstance speed = mob.getAttribute(Attributes.MOVEMENT_SPEED);
    ...
    private static void replaceTransientModifier(ModifiableAttributeInstance attribute,
                                                 UUID id,
                                                 String name,
                                                 double amount) {
