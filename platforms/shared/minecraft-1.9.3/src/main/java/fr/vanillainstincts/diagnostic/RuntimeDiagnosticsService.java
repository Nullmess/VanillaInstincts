...
public final class RuntimeDiagnosticsService {
    private static final Map<WorldServer, LevelDiagnostics> LEVELS =
            new WeakHashMap<>();
    ...
    public static DiagnosticReport latest(WorldServer level) {
    ...
    public static RuntimeHealthSnapshot latestSnapshot(WorldServer level) {
    ...
    public static List<DiagnosticViolation> recent(WorldServer level) {
    ...
    private static int saturatedTemporaryCount(WorldServer level) {
    ...
    private static void logTransition(WorldServer level,
                                      DiagnosticReport report) {
        String dimension = String.valueOf(level.provider.getDimension());
