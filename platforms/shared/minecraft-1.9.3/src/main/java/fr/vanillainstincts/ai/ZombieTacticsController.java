...
public final class ZombieTacticsController {
    ...
    private static void offerContextLeap(EntityZombie zombie, EntityLivingBase target,
        ...
        if (!fr.vanillainstincts.compat.Minecraft112Compat.hasCollision(zombie.worldObj.getBlockState(front),
    ...
    public static boolean canBreakWithHeldTool(EntityZombie zombie,
        ...
        return !fr.vanillainstincts.compat.Minecraft110ItemStackCompat.isEmpty(tool) && tool.getStrVsBlock(state) > 1.0F;
    }
