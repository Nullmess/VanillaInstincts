...
public final class GolemConstructionState {
    ...
    public static GolemConstructionState load(MobEntity mob) {
    ...
    public void sampleMovement(Vector3d position, long gameTime,
        ...
        Vector3d previous = new Vector3d(movementX, movementY, movementZ);
    ...
    private void setMovementSample(Vector3d position, long gameTime) {
