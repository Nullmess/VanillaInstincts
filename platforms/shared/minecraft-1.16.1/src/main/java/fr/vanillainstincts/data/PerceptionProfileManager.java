...
public final class PerceptionProfileManager
    ...
    public static PerceptionProfile profileFor(MobEntity mob) {
    ...
    public static double visualRange(MobEntity observer, LivingEntity target,
                                     ServerWorld level) {
    ...
    public static double hearingRadius(MobEntity observer, ServerWorld level,
                                       double baseRadius,
    ...
    public static int seenMemoryTicks(MobEntity mob) {
        return profileFor(mob).lastSeenTicks();
    }

    public static int heardMemoryTicks(MobEntity mob) {
        return profileFor(mob).lastHeardTicks();
    }

    public static double blindnessRange(MobEntity mob) {
    ...
    private static class EntityMatcher {
        ...
        boolean matches(EntityType<?> type) {
            ...
            if (tag) {
                return type.is(EntityTypeTags.bind(id.toString()));
            }
