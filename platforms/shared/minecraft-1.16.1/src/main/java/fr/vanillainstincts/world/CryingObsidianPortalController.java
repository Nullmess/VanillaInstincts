...
public final class CryingObsidianPortalController {
    ...
    /**
     * Minecraft 1.16.1 predates the PortalInfo-based dimension-entry API
     * used by the newer 1.16.x port. Crying-obsidian frame activation stays
     * available on this target, while destination interception is intentionally
     * left to vanilla/Forge 1.16.1 portal handling.
     */
