...
public class MobActionRequest {
    ...
    public Vec3 vector() { return this.vector; }
    ...
    public MobActionRequest(VanillaInstinctsState state, ActionOwner owner, MobActionType type, int priority, Vec3 vector, double speed, int holdTicks, Runnable onAccepted) {
