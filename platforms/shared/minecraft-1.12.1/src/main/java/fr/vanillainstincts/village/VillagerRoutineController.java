...
public final class VillagerRoutineController {
    ...
    public static void contribute(EntityVillager villager,
        ...
        if (crowd > VillageSocialRules.VILLAGER_COMFORTABLE_CROWD) {
            ...
            if (fr.vanillainstincts.compat.Minecraft112Compat.lengthSq(direction) > 1.0E-6D) {
                Vec3d requested = villager.getPositionVector().add(
    ...
    public static Optional<Vec3d> adjacentDestination(EntityVillager villager,
                                                      BlockPos objective) {
        ...
        for (int[] offset : offsets) {
            ...
            double score = villager.world instanceof WorldServer
                    ? VillagePathEvaluator.score(villager, ((WorldServer) (villager.world)), feet, objective)
    ...
    private static Vec3d separationDirection(EntityVillager villager,
                                            WorldServer level) {
        ...
        for (EntityVillager other : level.getEntitiesWithinAABB(EntityVillager.class,
            ...
            Vec3d delta = villager.getPositionVector().subtract(other.getPositionVector());
