...
public final class VanillaInstinctsController {
    ...
    public static void tick(EntityLiving mob) {
        if (!(mob.world instanceof WorldServer) || !mob.isEntityAlive()) {
            return;
        ...
        try {
            ...
            } else if (mob instanceof EntityZombieVillager) { EntityZombieVillager zombieVillager = (EntityZombieVillager) (mob); 
            ...
            } else if (mob instanceof AbstractSkeleton) { AbstractSkeleton skeleton = (AbstractSkeleton) (mob); 
