...
public final class SkeletonTacticsController {
    ...
    public static boolean supports(AbstractSkeleton skeleton) {
        return skeleton != null && !(skeleton instanceof EntityWitherSkeleton)
                && !SniperSkeletonController.isSniper(skeleton);
    }

    public static void maintain(AbstractSkeleton skeleton, WorldServer level,
                                long gameTime) {
    ...
    public static Optional<Vec3d> safeRetreatDestination(
            AbstractSkeleton skeleton, EntityLivingBase target,
    ...
    public static Vec3d retreatDestination(AbstractSkeleton skeleton,
                                          EntityLivingBase target,
                                          double distance) {
        Vec3d away = horizontal(skeleton.getPositionVector().subtract(target.getPositionVector()));
        if (away == null) away = new Vec3d(1.0D, 0.0D, 0.0D);
    ...
    public static Vec3d flankDestination(AbstractSkeleton skeleton,
                                        EntityLivingBase target,
                                        double sideDistance) {
        Vec3d radial = horizontal(skeleton.getPositionVector().subtract(target.getPositionVector()));
        if (radial == null) radial = new Vec3d(1.0D, 0.0D, 0.0D);
    ...
    private static Vec3d reacquireDestination(AbstractSkeleton skeleton,
                                             Vec3d remembered) {
