...
public final class Minecraft112Compat {
    ...
    private static double x(Object value) {
        ...
        if (value instanceof Vec3d) return ((Vec3d) value).x;
    ...
    private static double y(Object value) {
        ...
        if (value instanceof Vec3d) return ((Vec3d) value).y;
    ...
    private static double z(Object value) {
        ...
        if (value instanceof Vec3d) return ((Vec3d) value).z;
    ...
    public static Random random(Object owner) {
        ...
        if (owner instanceof Entity) {
            World world = ((Entity) owner).world;
    ...
    public static double lengthSq(Vec3d value) {
        return value == null ? 0.0D : value.x * value.x + value.y * value.y + value.z * value.z;
    }
    ...
    public static Vec3d multiply(Vec3d value, double x, double y, double z) {
        ...
        return new Vec3d(value.x * x, value.y * y, value.z * z);
    }
    ...
    public static void setMotion(Entity entity, Vec3d motion) {
        ...
        setMotion(entity, motion.x, motion.y, motion.z);
    }
    ...
    public static WorldServer[] levels(MinecraftServer server) {
        return server == null || server.worlds == null ? new WorldServer[0] : server.worlds;
    }
    ...
    public static void setItem(EntityItem entity, ItemStack stack) {
        if (entity != null) entity.setItem(stack == null ? ItemStack.EMPTY : stack);
    }
    ...
    public static void drop(EntityPlayerMP player, ItemStack stack) {
        if (player != null && stack != null && !stack.isEmpty()) player.dropItem(stack, false);
    }
    ...
    public static EntityItem spawnItem(Entity entity, ItemStack stack) {
        if (entity == null || stack == null || stack.isEmpty()) return null;
    ...
    public static net.minecraft.util.math.AxisAlignedBB moveBox(net.minecraft.util.math.AxisAlignedBB box, Vec3d delta) {
        ...
        return new net.minecraft.util.math.AxisAlignedBB(box.minX + delta.x, box.minY + delta.y, box.minZ + delta.z,
    ...
    public static boolean hasAdvancement(EntityPlayerMP player, net.minecraft.util.ResourceLocation id) {
        ...
        try {
            Object server = invokeAny(player, new String[]{"getServer", "getMinecraftServer"}, new Class<?>[0]);
            if (server == null && player.world != null) server = invokeAny(player.world, new String[]{"getMinecraftServer"}, new Class<?>[0]);
            if (server == null) return false;
            Object manager = invokeAny(server, new String[]{"getAdvancementManager", "getAdvancements"}, new Class<?>[0]);
            Object advancement = invokeAny(manager, new String[]{"getAdvancement"},
                    new Class<?>[]{net.minecraft.util.ResourceLocation.class}, id);
            if (advancement == null) return false;
            Object progress = invokeAny(player.getAdvancements(), new String[]{"getProgress", "getOrStartProgress"},
                    new Class<?>[]{net.minecraft.advancements.Advancement.class}, advancement);
            Object done = invokeAny(progress, new String[]{"isDone"}, new Class<?>[0]);
    ...
    public static net.minecraft.entity.projectile.EntityArrow mobArrow(net.minecraft.entity.monster.AbstractSkeleton skeleton,
            ItemStack bow, float distanceFactor) {
        if (skeleton == null || skeleton.world == null) return null;
        try {
            ...
            Object value = constructor.newInstance(skeleton.world, skeleton);
    ...
    public static void reassessWeaponGoal(net.minecraft.entity.monster.AbstractSkeleton skeleton) {
