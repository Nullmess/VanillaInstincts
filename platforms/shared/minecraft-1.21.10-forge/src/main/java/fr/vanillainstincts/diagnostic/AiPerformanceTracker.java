...
public final class AiPerformanceTracker {
    private static final Map<ServerLevel, LevelHistory> LEVELS =
            new WeakHashMap<>();
    ...
    public static void sample(ServerLevel level, long gameTime) {
    ...
    public static PerformanceSummary summary(ServerLevel level) {
