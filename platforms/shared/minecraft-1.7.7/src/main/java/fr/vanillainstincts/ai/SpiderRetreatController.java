...
public final class SpiderRetreatController {
    ...
    public static boolean contribute(EntitySpider spider, EntityLivingBase target,
        ...
        Vec3 away = fr.vanillainstincts.compat.Minecraft112Compat.multiply(fr.vanillainstincts.compat.Minecraft17Compat.position(spider).subtract(fr.vanillainstincts.compat.Minecraft17Compat.position(target)), 1.0D, 0.0D, 1.0D);
        ...
        Vec3 destination = fr.vanillainstincts.compat.Minecraft17Compat.position(spider).add(fr.vanillainstincts.compat.Minecraft112Compat.scale(away, 
    ...
    private static void maybePlaceRetreatWeb(EntitySpider spider,
        ...
        Vec3 towardThreat = fr.vanillainstincts.compat.Minecraft112Compat.multiply(fr.vanillainstincts.compat.Minecraft17Compat.position(target).subtract(fr.vanillainstincts.compat.Minecraft17Compat.position(spider)), 1.0D, 0.0D, 1.0D);
        if (fr.vanillainstincts.compat.Minecraft112Compat.lengthSq(towardThreat) < 1.0E-8D) return;
        BlockPos behind = new BlockPos(fr.vanillainstincts.compat.Minecraft17Compat.position(spider).add(
