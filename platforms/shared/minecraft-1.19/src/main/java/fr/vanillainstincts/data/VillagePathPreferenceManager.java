...
public final class VillagePathPreferenceManager
    ...
    public VillagePathPreferenceManager() {
        super(GSON, "villager_path_preferences");
    }
    ...
    public static double staticPreference(VillagerProfession profession,
        ...
        ResourceLocation professionId = Registry.VILLAGER_PROFESSION
                .getKey(profession);
        ResourceLocation feetId = Registry.BLOCK.getKey(feet.getBlock());
        ResourceLocation floorId = Registry.BLOCK.getKey(floor.getBlock());
    ...
    private record CacheKey(ResourceLocation profession,
                            ResourceLocation feet,
                            ResourceLocation floor) {
    }

    private record PathRule(ResourceLocation id,
                            int priority,
    ...
    private record WeightedBlockMatcher(boolean tag,
        ...
        boolean matches(BlockState state) {
            ...
            if (tag) {
                return state.is(TagKey.create(Registry.BLOCK_REGISTRY, id));
            }
