...
public final class VillagerProfessionController {
    ...
    private static boolean contributeCleric(
        ...
        EntityVillager injured = fr.vanillainstincts.compat.Minecraft112Compat.entitiesWithinAABB(level, EntityVillager.class,
        ...
        Vec3 destination = shelter == null ? fr.vanillainstincts.compat.Minecraft17Compat.position(injured)
                : VillagerRoutineController.adjacentDestination(cleric,
                shelter).orElse(fr.vanillainstincts.compat.Minecraft17Compat.position(injured));
