...
public final class AnimalWelfareController {
    ...
    private static boolean hasNearbyHerd(EntityAnimal animal, WorldServer level) {
        ...
        List<EntityAnimal> nearby = fr.vanillainstincts.compat.Minecraft112Compat.entitiesWithinAABB(level, EntityAnimal.class,
                fr.vanillainstincts.compat.Minecraft17Compat.boundingBox(animal).expand(radius, radius, radius),
