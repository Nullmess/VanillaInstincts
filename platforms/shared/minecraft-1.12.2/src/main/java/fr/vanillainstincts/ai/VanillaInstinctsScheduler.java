...
public final class VanillaInstinctsScheduler {
    ...
    public static boolean isScheduled(Entity entity, int intervalTicks) {
        ...
        if (entity.world instanceof WorldServer) { WorldServer level = (WorldServer) (entity.world); 
            TickBudget budget;
        ...
        return Math.floorMod(entity.world.getTotalWorldTime() + entity.getEntityId(),
                interval) == 0L;
    }
