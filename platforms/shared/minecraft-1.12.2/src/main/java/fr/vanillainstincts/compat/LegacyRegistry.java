...
public final class LegacyRegistry<T> implements Iterable<T> {
    public static final LegacyRegistry<Block> BLOCK = fromForge(ForgeRegistries.BLOCKS);
    public static final LegacyRegistry<Item> ITEM = fromForge(ForgeRegistries.ITEMS);
    public static final LegacyRegistry<Biome> BIOME = fromForge(ForgeRegistries.BIOMES);
    public static final LegacyRegistry<Potion> POTION = fromForge(ForgeRegistries.POTIONS);
