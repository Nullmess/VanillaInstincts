...
public final class VillagerGrandMasterController {
    ...
    public static boolean hasNetheriteMarker(Villager villager) {
        return villager != null
                && villager.hasEffect(VanillaInstinctsMobEffects.grandMasterHolder());
    }
    ...
    private static void ensureMarker(Villager villager) {
        ...
        if (!villager.hasEffect(VanillaInstinctsMobEffects.grandMasterHolder())) {
            villager.addEffect(new MobEffectInstance(
                    VanillaInstinctsMobEffects.grandMasterHolder(),
    ...
    private static void removeMarker(Villager villager) {
        ...
        if (villager.hasEffect(VanillaInstinctsMobEffects.grandMasterHolder())) {
            villager.removeEffect(VanillaInstinctsMobEffects.grandMasterHolder());
        }
    }
    ...
    private static long currentDay(ServerLevel level) {
        return Math.floorDiv(level.getOverworldClockTime(), 24_000L);
    }
}
