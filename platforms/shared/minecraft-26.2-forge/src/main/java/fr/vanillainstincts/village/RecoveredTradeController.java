...
public final class RecoveredTradeController {
    ...
    public static boolean recover(AbstractVillager merchant, ItemEntity entity) {
        ...
        int incidentScore = fr.vanillainstincts.persistence.NbtCompat.getInt(merchant.getPersistentData(), "vanillainstincts_price_incident_score");
        if (incidentScore > 0) {
    ...
    public static boolean isPlayerDeathDrop(ItemEntity entity) {
        return entity != null && fr.vanillainstincts.persistence.NbtCompat.getBoolean(entity.getPersistentData(), PLAYER_DEATH_DROP);
    }

    public static boolean isPlayerOrigin(ItemEntity entity) {
        return entity != null && (fr.vanillainstincts.persistence.NbtCompat.getBoolean(entity.getPersistentData(), PLAYER_TOSSED_ITEM)
                || fr.vanillainstincts.persistence.NbtCompat.getBoolean(entity.getPersistentData(), PLAYER_DEATH_DROP)
    ...
    private static void markPlayerRecoveredOffer(AbstractVillager merchant,
                                                  int index) {
        int[] previous = fr.vanillainstincts.persistence.NbtCompat.getIntArray(merchant.getPersistentData(), PLAYER_RECOVERED_OFFER_INDICES);
    ...
    private static boolean isPlayerRecoveredOffer(AbstractVillager merchant,
                                                   int index) {
        for (int stored : fr.vanillainstincts.persistence.NbtCompat.getIntArray(merchant.getPersistentData(), PLAYER_RECOVERED_OFFER_INDICES)) {
    ...
    public static boolean accepts(VillagerProfession profession,
        ...
        if (profession == VillagerProfessionCompat.value(VillagerProfession.ARMORER)
    ...
    private static long nextOfferSalt(AbstractVillager merchant) {
        ...
        long sequence = fr.vanillainstincts.persistence.NbtCompat.getLong(merchant.getPersistentData(), key) + 1L;
        merchant.getPersistentData().putLong(key, sequence);
        long day = merchant.level().getOverworldClockTime() / 24_000L;
