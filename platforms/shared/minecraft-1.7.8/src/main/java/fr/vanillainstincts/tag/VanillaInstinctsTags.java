...
public final class VanillaInstinctsTags {
    public static final LegacyTag<Block> PROTECTED_BLOCKS =
            createBlock("protected_blocks");
    public static final LegacyTag<Block> VILLAGER_DANGEROUS_BLOCKS =
            createBlock("villager_dangerous_blocks");
    public static final LegacyTag<Block> VILLAGE_SAFE_PATHS =
            createBlock("village_safe_paths");
    public static final LegacyTag<Block> FARMER_HARVESTABLES =
            createBlock("farmer_harvestables");
    public static final LegacyTag<Block> FARMER_PLANTABLE_ON =
            createBlock("farmer_plantable_on");
    public static final LegacyTag<Item> FARMER_HOES =
            Minecraft115TagCompat.itemTag(VanillaInstincts.id("farmer_hoes"));
    public static final LegacyTag<Item> VILLAGER_SHAREABLE_FOOD =
            Minecraft115TagCompat.itemTag(
                    VanillaInstincts.id("villager_shareable_food"));

    private static LegacyTag<Block> createBlock(String name) {
