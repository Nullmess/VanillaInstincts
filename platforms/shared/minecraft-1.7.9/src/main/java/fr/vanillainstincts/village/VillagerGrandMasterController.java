...
public final class VillagerGrandMasterController {
    ...
    private static void celebrate(EntityVillager villager, WorldServer level) {
        fr.vanillainstincts.compat.Minecraft18SoundCompat.play(level, entityBlockPos(villager), "mob.villager.yes", 1.0F, 0.85F + level.rand.nextFloat() * 0.2F);
        ...
        fr.vanillainstincts.compat.Minecraft17Compat.spawnParticle(level, EnumParticleTypes.FLAME,
