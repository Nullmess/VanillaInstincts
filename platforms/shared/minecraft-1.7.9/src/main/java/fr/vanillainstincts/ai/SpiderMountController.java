...
public final class SpiderMountController {
    ...
    public static boolean contribute(EntitySpider spider, EntityLivingBase target,
        ...
        List<EntitySkeleton> candidates = fr.vanillainstincts.compat.Minecraft112Compat.entitiesWithinAABB(level, 
                EntitySkeleton.class,
                fr.vanillainstincts.compat.Minecraft112Compat.expandBox(fr.vanillainstincts.compat.Minecraft17Compat.boundingBox(spider), 
