...
class VillagePlacement {
    ...
    public VillagePlacement(BlockPos pos, LegacyBlockState state, boolean terrainReplacement, boolean road, ResourceLocation lootTable, long lootTableSeed) {
        this.pos = pos;
        this.state = state;
    ...
    VillagePlacement(BlockPos pos, LegacyBlockState state,
