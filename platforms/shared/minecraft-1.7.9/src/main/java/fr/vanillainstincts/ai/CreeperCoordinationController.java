...
public final class CreeperCoordinationController {
    ...
    private static Optional<Vec3> findCover(EntityCreeper creeper, EntityPlayer target,
        ...
        for (Vec3 candidate : candidates) {
            ...
            MovingObjectPosition ray = level.rayTraceBlocks(fr.vanillainstincts.compat.Minecraft17Compat.eyes(target, 1.0F),fr.vanillainstincts.compat.Minecraft112Compat.add(safe.get(), 0.0D, creeper.getEyeHeight(), 0.0D), false, true, false);
