...
public final class VillageAssemblyController {
    ...
    public static boolean contribute(EntityVillager villager,
        ...
        List<EntityVillager> villagers = fr.vanillainstincts.compat.Minecraft112Compat.entitiesWithinAABB(level, EntityVillager.class,
                fr.vanillainstincts.compat.Minecraft112Compat.expandBox(fr.vanillainstincts.compat.Minecraft17Compat.boundingBox(villager), 
        ...
        boolean protectedVillage = !fr.vanillainstincts.compat.Minecraft112Compat.entitiesWithinAABB(level, EntityIronGolem.class,
                fr.vanillainstincts.compat.Minecraft112Compat.expandBox(fr.vanillainstincts.compat.Minecraft17Compat.boundingBox(villager), 
                        VillageConstructionRules.VILLAGE_ASSEMBLY_RADIUS),
        ...
        Vec3 ring =fr.vanillainstincts.compat.Minecraft112Compat.add(Minecraft115VectorCompat.atBottomCenterOf(center), 
