...
public final class VillagerSafetyController {
    ...
    public static Optional<Vec3> findFleeDestination(EntityVillager villager,
                                                      WorldServer level,
                                                      BlockPos danger) {
        Vec3 away = villager.getPositionVector().subtract(Minecraft115VectorCompat.atCenterOf(danger));
    ...
    public static Optional<Vec3> findBehindDefenderDestination(
        ...
        Vec3 away = fr.vanillainstincts.compat.Minecraft112Compat.multiply(golem.getPositionVector().subtract(threatPosition), 1.0D, 0.0D, 1.0D);
        ...
        Vec3 center = golem.getPositionVector().add(fr.vanillainstincts.compat.Minecraft112Compat.scale(away, 
    ...
    private static Optional<EntityLivingBase> nearestImmediateThreat(
        ...
        AxisAlignedBB area = fr.vanillainstincts.compat.Minecraft112Compat.expandBox(villager.getEntityBoundingBox(), 
