...
public final class VillagerDoorController {
    ...
    public static Optional<BlockPos> findNearbyOpenDoor(VillagerEntity villager,
                                                        ServerWorld level) {
    ...
    private static void tryClosePending(VillagerEntity villager,
        ...
        door.setOpen(level, state, lower, false);
    ...
    private static boolean doorwayOccupied(ServerWorld level,
                                             BlockPos lower) {
