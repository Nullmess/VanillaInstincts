...
public final class TacticalCueController {
    ...
    public static void onActionAccepted(EntityLiving mob, VanillaInstinctsState previousState,
        ...
        Vec3d pos =fr.vanillainstincts.compat.Minecraft112Compat.add(mob.getPositionVector(), 0.0D,
    ...
    public static void emitEndermanDeliveryWarning(EntityEnderman enderman,
        ...
        Vec3d pos =fr.vanillainstincts.compat.Minecraft112Compat.add(enderman.getPositionVector(), 0.0D, 1.45D, 0.0D);
        level.spawnParticle(EnumParticleTypes.PORTAL,
    ...
    public static void emitGolemReport(EntityVillager villager, EntityIronGolem golem,
        ...
        Vec3d from =fr.vanillainstincts.compat.Minecraft112Compat.add(villager.getPositionVector(), 0.0D,
                villager.height + 0.2D, 0.0D);
        Vec3d to =fr.vanillainstincts.compat.Minecraft112Compat.add(golem.getPositionVector(), 0.0D, 1.7D, 0.0D);
        Vec3d delta = to.subtract(from);
        for (int step = 0; step <= 5; step++) {
            Vec3d point = from.add(delta.scale(step / 5.0D));
            level.spawnParticle(EnumParticleTypes.VILLAGER_ANGRY,
    ...
    public static void emitGolemRole(EntityIronGolem golem, GolemDefenseRole role,
        ...
        Vec3d pos =fr.vanillainstincts.compat.Minecraft112Compat.add(golem.getPositionVector(), 0.0D,
    ...
    public static void emitVillageAlert(EntityVillager villager,
        ...
        Vec3d pos =fr.vanillainstincts.compat.Minecraft112Compat.add(villager.getPositionVector(), 0.0D,
