...
public final class NetherReinforcementState {
    ...
    public static NetherReinforcementState load(EntityLiving mob) {
        ...
        state.missionId = tag.hasUniqueId("mission_id")
                ? tag.getUniqueId("mission_id") : null;
        state.aggressorId = tag.hasUniqueId("aggressor_id")
                ? tag.getUniqueId("aggressor_id") : null;
    ...
    public void save(EntityLiving mob) {
        ...
        if (missionId != null) tag.setUniqueId("mission_id", missionId);
        if (aggressorId != null) tag.setUniqueId("aggressor_id", aggressorId);
