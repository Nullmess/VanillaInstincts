...
public final class RecoveredTradeController {
    ...
    private static EntityItem nearestAccepted(EntityVillager merchant,
        ...
        return level.getEntitiesWithinAABB(EntityItem.class,
                        merchant.getEntityBoundingBox().expand(radius, 16.0D, radius),
    ...
    public static boolean usefulToWanderingTrader(ItemStack stack) {
        ...
        return !stack.getItem().equals(net.minecraft.item.Item.getItemFromBlock(net.minecraft.init.Blocks.AIR)) && !stack.getItem().equals(net.minecraft.item.Item.getItemFromBlock(net.minecraft.init.Blocks.BARRIER))
