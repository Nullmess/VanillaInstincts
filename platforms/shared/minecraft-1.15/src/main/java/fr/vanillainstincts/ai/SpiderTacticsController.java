...
public final class SpiderTacticsController {
    ...
    public static void maintainAttachment(SpiderEntity spider,
        ...
        if (species.spiderSurfaceMode() == SpiderSurfaceMode.CEILING) {
            if (ceiling) {
                ...
                Vec3d movement = spider.getDeltaMovement();
    ...
    public static void contributeFromMemory(SpiderEntity spider, Vec3d destination,
                                            SpeciesRuntimeState species,
                                            MobDecisionPlan plan,
                                            ServerWorld level, long gameTime) {
    ...
    private static boolean trySurfaceTraversal(SpiderEntity spider, Vec3d destination,
                                               SpeciesRuntimeState species,
                                               MobDecisionPlan plan,
                                               ServerWorld level,
                                               long gameTime) {
        ...
        if (desired == SpiderSurfaceMode.WALL) {
            ...
            Vec3d impulse = new Vec3d(forward.x,
    ...
    private static boolean tryContextualLeap(SpiderEntity spider,
        ...
        Vec3d horizontal = horizontal(target.position()
