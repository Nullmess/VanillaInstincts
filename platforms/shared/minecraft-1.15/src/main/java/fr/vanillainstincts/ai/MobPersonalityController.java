...
public final class MobPersonalityController {
    ...
    public static MobPersonality profileFor(EndermanEntity enderman) {
        if (enderman == null) return MobPersonality.GENERIC;
        CompoundNBT persistent = enderman.getPersistentData();
    ...
    public static int stableBucket(EndermanEntity enderman, int bound) {
