...
public final class AnimalComfortController {
    ...
    public static void recordFear(AnimalEntity animal, Vec3d source, long gameTime) {
    ...
    public static Optional<Vec3d> fearSource(AnimalEntity animal, long gameTime) {
        if (animal == null
                || animal.getPersistentData().getLong(FEAR_UNTIL) <= gameTime) {
            return Optional.empty();
        }
        return Optional.of(Minecraft115VectorCompat.atCenterOf(BlockPos.of(
    ...
    public static Optional<Vec3d> rememberedShelter(AnimalEntity animal,
                                                    ServerWorld level,
                                                    long gameTime) {
    ...
    private static Vec3d localHerdAnchor(AnimalEntity animal, ServerWorld level) {
    ...
    public static Optional<Vec3d> findShelter(AnimalEntity animal,
                                             ServerWorld level) {
        if (animal == null || level == null) {
            return Optional.empty();
        }
    ...
    public static Optional<Vec3d> findDryGround(AnimalEntity animal,
                                               ServerWorld level) {
        if (animal == null || level == null) {
            return Optional.empty();
        }
