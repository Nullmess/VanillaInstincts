...
public final class GolemConstructionState {
    ...
    public static GolemConstructionState load(EntityLiving mob) {
        ...
        state.constructionTargetId = fr.vanillainstincts.compat.Minecraft18NbtCompat.hasUniqueId(tag, "construction_target_id")
                ? fr.vanillainstincts.compat.Minecraft18NbtCompat.getUniqueId(tag, "construction_target_id") : null;
        ...
        state.refresh(mob.worldObj.getTotalWorldTime());
        return state;
    }
    ...
    public void save(EntityLiving mob) {
        ...
        if (constructionTargetId != null) {
            fr.vanillainstincts.compat.Minecraft18NbtCompat.setUniqueId(tag, "construction_target_id", constructionTargetId);
        }
    ...
    private void setMovementSample(Vec3 position, long gameTime) {
        movementX = position.xCoord;
        movementY = position.yCoord;
        movementZ = position.zCoord;
