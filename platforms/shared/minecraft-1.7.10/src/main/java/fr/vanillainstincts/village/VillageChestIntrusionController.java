...
public final class VillageChestIntrusionController {
    ...
    public static int onContainerOpened(WorldServer level, BlockPos container,
        ...
        AxisAlignedBB area = fr.vanillainstincts.compat.Minecraft112Compat.expandBox(AxisAlignedBB.getBoundingBox(container.getX(), container.getY(),
    ...
    public static boolean isHouseWitness(EntityVillager villager,
        ...
        boolean indoors = !fr.vanillainstincts.compat.Minecraft17Compat.canSeeSky(level, entityBlockPos(villager))
