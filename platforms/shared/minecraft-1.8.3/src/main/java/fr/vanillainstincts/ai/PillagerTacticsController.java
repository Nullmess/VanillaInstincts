...
public final class PillagerTacticsController {
    ...
    public static void contribute(PillagerEntity pillager, MobDecisionPlan plan,
        ...
        List<PillagerEntity> squad = level.getEntitiesWithinAABB(PillagerEntity.class,
                fr.vanillainstincts.compat.Minecraft112Compat.expandBox(pillager.getEntityBoundingBox(), 
    ...
    public static Vec3 coverDestination(PillagerEntity pillager,
        ...
        Vec3 away = pillager.getPositionVector().subtract(target.getPositionVector())
    ...
    public static Vec3 flankDestination(PillagerEntity pillager,
                                        EntityLivingBase target,
                                        int squadSize) {
        Vec3 radial = pillager.getPositionVector().subtract(target.getPositionVector())
                .multiply(1.0D, 0.0D, 1.0D);
