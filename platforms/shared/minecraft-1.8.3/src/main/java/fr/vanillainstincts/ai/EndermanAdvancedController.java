...
public final class EndermanAdvancedController {
    ...
    public static boolean contributeBlockedAggro(EntityEnderman enderman,
        ...
        plan.offerSpecial(VanillaInstinctsState.ENDERMAN_FORCED_TELEPORT,
                ...
                20, () -> {
                    Vec3 before = player.getPositionVector();
    ...
    public static boolean contributeDrowningRescue(EntityEnderman enderman,
        ...
        EntityLivingBase drowning = level.getEntitiesWithinAABB(EntityLivingBase.class,
                        fr.vanillainstincts.compat.Minecraft112Compat.expandBox(enderman.getEntityBoundingBox(), 
        ...
        plan.offerSpecial(VanillaInstinctsState.TELEPORT_CARGO,
                ...
                16, () -> {
                    Vec3 before = drowning.getPositionVector();
    ...
    public static boolean contributeCarriedBlockPresentation(
        ...
        Vec3 look = fr.vanillainstincts.compat.Minecraft112Compat.multiply(player.getLookVec(), 1.0D, 0.0D, 1.0D);
        ...
        Vec3 requested = player.getPositionVector().subtract(fr.vanillainstincts.compat.Minecraft112Compat.scale(look, 
    ...
    public static Optional<Vec3> selectPunishmentDestination(
        ...
        List<EntityMob> hostiles = level.getEntitiesWithinAABB(EntityMob.class,
                fr.vanillainstincts.compat.Minecraft112Compat.expandBox(player.getEntityBoundingBox(), 
    ...
    private static Optional<Vec3> safeNearEntity(EntityPlayer player,
        ...
        for (int i = 0; i < 8; i++) {
            ...
            Vec3 candidate =fr.vanillainstincts.compat.Minecraft112Compat.add(entity.getPositionVector(), Math.cos(angle) * 3.0D,
    ...
    private static Optional<Vec3> findLoadedLava(EntityPlayer player,
        ...
        for (BlockPos pos : fr.vanillainstincts.compat.Minecraft112BlockPosCompat.betweenClosed(
            ...
            if (level.getBlockState(pos).getBlock().getMaterial() == Material.lava
    ...
    private static boolean safeForPlayer(EntityPlayer player, Vec3 candidate,
        ...
        if (!level.isBlockLoaded(feet)
                || !!level.getBlockState(feet).getBlock().getMaterial().isLiquid()) return false;
