...
public final class GolemDefenseController {
    ...
    public static void contribute(EntityIronGolem golem,
        ...
        Vec3 desired = fr.vanillainstincts.compat.LegacyJava8.eval(() -> { switch ((state.role())) { case INTERCEPTOR:  return interpositionPoint(target.getPositionVector(),
                    protectedPoint,
    ...
    private static void observeNearbyDefender(EntityIronGolem golem,
        ...
        AxisAlignedBB area = fr.vanillainstincts.compat.Minecraft112Compat.expandBox(golem.getEntityBoundingBox(), 
