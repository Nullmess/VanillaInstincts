...
public final class ZombieTacticsController {
    ...
    private static void offerContextLeap(EntityZombie zombie, EntityLivingBase target,
        ...
        Vec3 horizontal = fr.vanillainstincts.compat.Minecraft112Compat.multiply(target.getPositionVector().subtract(zombie.getPositionVector()), 1.0D, 0.0D, 1.0D);
    ...
    public static Optional<BlockPos> findToolObstacle(EntityZombie zombie,
                                                       Vec3 destination,
                                                       WorldServer level) {
        Vec3 horizontal = fr.vanillainstincts.compat.Minecraft112Compat.multiply(destination.subtract(zombie.getPositionVector()), 1.0D, 0.0D, 1.0D);
    ...
    public static boolean canBreakWithHeldTool(EntityZombie zombie,
        ...
        float hardness = state.getBlock().getBlockHardness(level, pos);
