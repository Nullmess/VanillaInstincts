...
public final class Minecraft112Compat {
    ...
    private static double x(Object value) {
        ...
        if (value instanceof Vec3) return ((Vec3) value).xCoord;
    ...
    private static double y(Object value) {
        ...
        if (value instanceof Vec3) return ((Vec3) value).yCoord;
    ...
    private static double z(Object value) {
        ...
        if (value instanceof Vec3) return ((Vec3) value).zCoord;
    ...
    public static double lengthSq(Vec3 value) {
    ...
    public static Vec3 scale(Vec3 value, double factor) {
    ...
    public static net.minecraft.util.AxisAlignedBB blockBox(BlockPos pos) {
        if (pos == null) return new net.minecraft.util.AxisAlignedBB(0, 0, 0, 1, 1, 1);
        return new net.minecraft.util.AxisAlignedBB(pos, pos.add(1, 1, 1));
    }
    ...
    public static boolean isRainingAt(World world, BlockPos pos) {
        return world != null && pos != null && world.isRaining() && world.canSeeSky(pos);
    }
    ...
    public static Vec3 multiply(Vec3 value, double x, double y, double z) {
        if (value == null) return new Vec3(0.0D, 0.0D, 0.0D);
        return new Vec3(value.xCoord * x, value.yCoord * y, value.zCoord * z);
    }

    public static Vec3 add(Vec3 value, double x, double y, double z) {
    ...
    public static boolean isSolidRender(IBlockState state) {
        return state != null && state.getBlock().isFullCube();
    }
    ...
    public static net.minecraft.entity.player.EntityPlayer player(WorldServer level, UUID id) {
        ...
        return level.getMinecraftServer().getConfigurationManager().getPlayerByUUID(id);
    }
    ...
    public static boolean hasCollision(IBlockState state, World world, BlockPos pos) {
        ...
        net.minecraft.util.AxisAlignedBB aabb = state.getBlock().getCollisionBoundingBox(world, pos, state);
    ...
    public static net.minecraft.util.AxisAlignedBB moveBox(net.minecraft.util.AxisAlignedBB box, Vec3 delta) {
        if (box == null || delta == null) return box;
        return new net.minecraft.util.AxisAlignedBB(box.minX + delta.xCoord, box.minY + delta.yCoord, box.minZ + delta.zCoord,
    ...
    public static net.minecraft.util.AxisAlignedBB shrinkBox(net.minecraft.util.AxisAlignedBB box, double amount) {
        ...
        return new net.minecraft.util.AxisAlignedBB(box.minX + amount, box.minY + amount, box.minZ + amount,
    ...
    public static double explosionExposure(World world, Vec3 center, Entity target) {
        if (world == null || center == null || target == null) return 0.0D;
        Object result = invokeAny(world, new String[]{"getBlockDensity"},
                new Class<?>[]{Vec3.class, net.minecraft.util.AxisAlignedBB.class}, center, target.getEntityBoundingBox());
