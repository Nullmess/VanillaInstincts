...
public final class GolemDefenseState {
    ...
    public static GolemDefenseState load(EntityIronGolem golem) {
        ...
        state.targetId = fr.vanillainstincts.compat.Minecraft18NbtCompat.hasUniqueId(tag, "target_id")
                ? fr.vanillainstincts.compat.Minecraft18NbtCompat.getUniqueId(tag, "target_id") : null;
        state.protectedVillagerId = fr.vanillainstincts.compat.Minecraft18NbtCompat.hasUniqueId(tag, "protected_villager_id")
                ? fr.vanillainstincts.compat.Minecraft18NbtCompat.getUniqueId(tag, "protected_villager_id") : null;
    ...
    public void save(EntityIronGolem golem) {
        ...
        if (targetId != null) fr.vanillainstincts.compat.Minecraft18NbtCompat.setUniqueId(tag, "target_id", targetId);
        if (protectedVillagerId != null) {
            fr.vanillainstincts.compat.Minecraft18NbtCompat.setUniqueId(tag, "protected_villager_id", protectedVillagerId);
        }
