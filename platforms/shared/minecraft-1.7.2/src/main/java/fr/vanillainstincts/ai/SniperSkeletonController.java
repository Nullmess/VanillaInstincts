...
public final class SniperSkeletonController {
    ...
    private static int countLocalSnipers(EntitySkeleton skeleton,
        ...
        return fr.vanillainstincts.compat.Minecraft112Compat.entitiesWithinAABB(level, EntitySkeleton.class,
                fr.vanillainstincts.compat.Minecraft17Compat.boundingBox(skeleton).expand(radius, radius, radius),
