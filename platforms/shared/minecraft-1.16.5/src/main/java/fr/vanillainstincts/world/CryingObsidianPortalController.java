...
public final class CryingObsidianPortalController {
     ...
     */
    public static boolean tryActivateAtIgnitionPosition(ServerWorld level,
        ...
        VanillaInstincts.LOGGER.info(
                ...
                frame.bottomLeft(), level.dimension().location(),
                frame.axis(), frame.width(), frame.height());
        level.playSound(null, frame.bottomLeft(),
                SoundEvents.PORTAL_TRIGGER, SoundCategory.BLOCKS,
     ...
     */
    public static boolean tryActivateFromFire(ServerWorld level,
                                              BlockPos firePos) {
     ...
     */
    public static PortalInfo createRoofPortalInfo(
            ServerWorld sourceLevel, Entity entity, BlockPos portalPos) {
        ...
        VanillaInstincts.LOGGER.info(
                ...
                portalPos, sourceLevel.dimension().location(), axis);
        ...
        if (World.OVERWORLD.equals(sourceLevel.dimension())) {
            return portalInfoFromOverworld(server, sourceLevel, entity,
                    sourceFrame);
        }
        if (World.NETHER.equals(sourceLevel.dimension())) {
            return portalInfoFromNether(server, sourceLevel, entity,
                    sourceFrame);
        }
        return null;
    }

    private static PortalInfo portalInfoFromOverworld(
            MinecraftServer server, ServerWorld overworld, Entity entity,
    ...
    private static PortalInfo portalInfoFromNether(
            MinecraftServer server, ServerWorld nether, Entity entity,
        ...
        return portalInfo(overworldFrame.bottomLeft(), entity);
    }

    private static PortalInfo portalInfo(BlockPos arrival, Entity entity) {
        return new PortalInfo(Vector3d.atBottomCenterOf(arrival), Vector3d.ZERO,
                entity.yRot, entity.xRot);
    }

    private static PortalDestination exactLinkedDestination(
            ServerWorld nether, CryingPortalLinkSavedData data,
            PortalFrame sourceFrame) {
    ...
    private static CryingPortalLinkSavedData.PortalLink linkedOverworldSource(
            ServerWorld overworld, CryingPortalLinkSavedData data,
    ...
    private static PortalDestination discoverRoofDestination(
            ServerWorld level, BlockPos target, int radius) {
        long bestDistance = Long.MAX_VALUE;
        PortalDestination best = null;
        Set<String> checked = new HashSet<>();
    ...
    private static PortalFrame activeFrame(IBlockReader level,
                                           BlockPos interior,
                                           Direction.Axis axis) {
    ...
    public static boolean isReusablePortal(IBlockReader level,
                                            BlockPos frameBase,
                                            Direction.Axis axis) {
        BlockPos interior = arrivalPosition(frameBase, axis);
     ...
     */
    public static boolean isCryingPortal(IBlockReader level, BlockPos pos,
                                         Direction.Axis axis) {
    ...
    public static PortalFrame findFrame(IBlockReader level, BlockPos candidate,
                                        Direction.Axis axis) {
    ...
    private static PortalFrame findIgnitableFrame(IBlockReader level,
                                                   BlockPos ignitionPos) {
        if (level == null || ignitionPos == null
                || !isInterior(level.getBlockState(ignitionPos))) {
            return null;
        }
        for (Direction.Axis axis : fr.vanillainstincts.compat.LegacyJava8.listOf(Direction.Axis.X,
                Direction.Axis.Z)) {
    ...
    private static boolean isPortalDimension(ServerWorld level) {
        return World.OVERWORLD.equals(level.dimension())
                || World.NETHER.equals(level.dimension());
    }
     ...
     */
    private static boolean createPortalDirect(ServerWorld level,
                                              PortalFrame frame) {
        return fillPortalDirectly(level, frame);
    }

    private static boolean fillPortalDirectly(ServerWorld level,
                                              PortalFrame frame) {
    ...
    private static BlockPos findPortalSite(ServerWorld level,
                                           BlockPos target,
                                           Direction.Axis axis,
                                           int radius,
                                           boolean fixedRoofY) {
    ...
    public static boolean portalSiteClear(IBlockReader level, BlockPos base,
                                          Direction.Axis axis) {
    ...
    private static boolean buildMinimumCryingPortal(ServerWorld level,
                                                     BlockPos base,
                                                     Direction.Axis axis) {
        ...
        VanillaInstincts.LOGGER.info(
                ...
                base, level.dimension().location(), axis);
        return true;
    }
    ...
    private static class PortalDestination {
        private final BlockPos frameBase;
        private final Direction.Axis axis;

        public PortalDestination(BlockPos frameBase, Direction.Axis axis) {
            this.frameBase = frameBase;
            this.axis = axis;
        }

        public BlockPos frameBase() { return this.frameBase; }

        public Direction.Axis axis() { return this.axis; }

        @Override
        public boolean equals(Object other) {
            if (this == other) return true;
            if (!(other instanceof PortalDestination)) return false;
            PortalDestination that = (PortalDestination) other;
            return java.util.Objects.equals(this.frameBase, that.frameBase) && java.util.Objects.equals(this.axis, that.axis);
        }

        @Override
        public int hashCode() { return java.util.Objects.hash(this.frameBase, this.axis); }

        @Override
        public String toString() {
            return "PortalDestination[" + "frameBase=" + this.frameBase + ", " + "axis=" + this.axis + "]";
        }
    ...
    public static class PortalFrame {
        ...
        public PortalFrame(BlockPos bottomLeft, Direction.Axis axis, int width, int height) {
        ...
        public BlockPos bottomLeft() { return this.bottomLeft; }
        ...
        public boolean equals(Object other) {
            if (this == other) return true;
            if (!(other instanceof PortalFrame)) return false;
            PortalFrame that = (PortalFrame) other;
            return java.util.Objects.equals(this.bottomLeft, that.bottomLeft) && java.util.Objects.equals(this.axis, that.axis) && this.width == that.width && this.height == that.height;
        }

        @Override
        public int hashCode() { return java.util.Objects.hash(this.bottomLeft, this.axis, this.width, this.height); }

        @Override
        public String toString() {
            return "PortalFrame[" + "bottomLeft=" + this.bottomLeft + ", " + "axis=" + this.axis + ", " + "width=" + this.width + ", " + "height=" + this.height + "]";
        }
