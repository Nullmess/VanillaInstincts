...
public final class VillageThreatRegistry {
    ...
    private static final Map<ServerWorld, Map<Long, List<Threat>>> LEVELS =
            new WeakHashMap<>();
    private static final Map<ServerWorld, Long> LAST_CLEANUP =
            new WeakHashMap<>();
    ...
    public static ThreatSnapshot reportVillagerAttack(
            VillagerEntity witness, ServerWorld level, Entity attacker,
    ...
    public static ThreatSnapshot reportVillagerPursuit(
            VillagerEntity witness, ServerWorld level, LivingEntity pursuer,
            long gameTime) {
    ...
    public static ThreatSnapshot reportGolemAttack(
            IronGolemEntity witness, ServerWorld level, Entity attacker,
            float damage, long gameTime) {
    ...
    public static ThreatSnapshot reportDefenseSignal(
            IronGolemEntity witness, ServerWorld level, LivingEntity attacker,
            long gameTime) {
        return report(witness, level, attacker, 2.0F, gameTime,
                GolemRules.GOLEM_ALLY_SIGNAL_TICKS, true);
    }

    private static ThreatSnapshot report(Entity witness, ServerWorld level,
    ...
    public static boolean activateForDefense(ServerWorld level, long id,
                                             long gameTime) {
    ...
    public static Optional<ThreatSnapshot> nearestThreat(
            ServerWorld level, BlockPos position, long gameTime,
            double radius) {
    ...
    public static Optional<ThreatSnapshot> byId(ServerWorld level,
                                                 long id,
                                                 long gameTime) {
    ...
    public static LivingEntity resolveAggressor(ServerWorld level,
     ...
     */
    public static int clearAggressor(ServerWorld level, UUID aggressorId) {
    ...
    private static VillageThreatType classify(Entity attacker) {
        if (attacker instanceof PlayerEntity) return VillageThreatType.PLAYER_ASSAULT;
    ...
    private static void cleanupLocked(ServerWorld level, long gameTime) {
