...
public final class AiPerformanceTracker {
    private static final Map<ServerWorld, LevelHistory> LEVELS =
            new WeakHashMap<>();
    ...
    public static void sample(ServerWorld level, long gameTime) {
    ...
    public static PerformanceSummary summary(ServerWorld level) {
