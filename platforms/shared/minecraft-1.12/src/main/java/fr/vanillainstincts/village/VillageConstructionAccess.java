...
public final class VillageConstructionAccess {
    ...
    private static boolean standable(WorldServer level, BlockPos feet) {
        ...
        return !fr.vanillainstincts.compat.Minecraft112Compat.isAir(floor) && !floor.getMaterial().isLiquid()
                && (fr.vanillainstincts.compat.Minecraft112Compat.isAir(body) || body.getMaterial().isReplaceable())
