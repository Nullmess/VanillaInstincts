 ...
 */
public final class MobRelationManager extends VanillaJsonReloadListener {
    ...
    private static RelationRule parse(Identifier id, JsonElement element) {
    ...
    private record RelationRule(Identifier id,
                                int priority,
