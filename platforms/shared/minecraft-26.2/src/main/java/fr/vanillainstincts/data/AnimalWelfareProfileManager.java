...
public final class AnimalWelfareProfileManager
    ...
    private static final WelfareProfile DEFAULT = new WelfareProfile(
            Identifier.fromNamespaceAndPath(VanillaInstincts.MOD_ID,
    ...
    private static WelfareProfile parse(Identifier id,
                                        JsonElement element) {
    ...
    public record WelfareProfile(Identifier id,
                                 int priority,
