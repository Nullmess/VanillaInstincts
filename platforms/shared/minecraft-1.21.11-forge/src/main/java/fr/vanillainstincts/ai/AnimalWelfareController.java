...
public final class AnimalWelfareController {
    ...
    public static WelfareSnapshot maintain(Animal animal, ServerLevel level,
        ...
        long recoverUntil = fr.vanillainstincts.persistence.NbtCompat.getLong(animal.getPersistentData(), RECOVER_UNTIL);
    ...
    public static AnimalWelfareState state(Animal animal) {
        ...
        String raw = fr.vanillainstincts.persistence.NbtCompat.getString(animal.getPersistentData(), STATE);
    ...
    public static int score(Animal animal) {
        ...
        return Math.max(0, Math.min(100,
                fr.vanillainstincts.persistence.NbtCompat.getInt(animal.getPersistentData(), SCORE)));
    }
