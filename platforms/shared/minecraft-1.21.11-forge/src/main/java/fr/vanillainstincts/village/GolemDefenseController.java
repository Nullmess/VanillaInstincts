...
public final class GolemDefenseController {
    ...
    private static void setAngryTarget(IronGolem golem,
        ...
        golem.setPersistentAngerTarget(net.minecraft.world.entity.EntityReference.of(target));
        golem.setTimeToRemainAngry(Math.max(20, angerTicks));
    }
    ...
    private static void finishMission(IronGolem golem,
        ...
        if (assigned != null && golem.getPersistentAngerTarget() != null
                && assigned.equals(golem.getPersistentAngerTarget().getUUID())) {
            golem.setPersistentAngerTarget(null);
            golem.setTimeToRemainAngry(0);
        }
        MobRunController.setGolemDefenseSprint(golem, false);
        state.clearMission();
    }
