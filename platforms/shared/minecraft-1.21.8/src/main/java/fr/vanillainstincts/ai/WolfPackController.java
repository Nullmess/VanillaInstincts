...
public final class WolfPackController {
    ...
    private static LivingEntity resolvePackTarget(Wolf wolf,
        ...
        if (fr.vanillainstincts.persistence.NbtCompat.getLong(wolf.getPersistentData(), TRACK_UNTIL) > gameTime) {
            BlockPos last = new BlockPos(
                    fr.vanillainstincts.persistence.NbtCompat.getInt(wolf.getPersistentData(), TRACK_X),
                    fr.vanillainstincts.persistence.NbtCompat.getInt(wolf.getPersistentData(), TRACK_Y),
                    fr.vanillainstincts.persistence.NbtCompat.getInt(wolf.getPersistentData(), TRACK_Z));
    ...
    private static void rememberTerritory(Wolf wolf, List<Wolf> pack,
                                          long gameTime) {
        if (fr.vanillainstincts.persistence.NbtCompat.getLong(wolf.getPersistentData(), TERRITORY_UNTIL) > gameTime) {
            return;
        }
        double x = wolf.getX();
        double y = wolf.getY();
    ...
    private static boolean outsideTerritory(Wolf wolf, LivingEntity target,
        ...
        BlockPos center = new BlockPos(
                fr.vanillainstincts.persistence.NbtCompat.getInt(wolf.getPersistentData(), TERRITORY_X),
                fr.vanillainstincts.persistence.NbtCompat.getInt(wolf.getPersistentData(), TERRITORY_Y),
                fr.vanillainstincts.persistence.NbtCompat.getInt(wolf.getPersistentData(), TERRITORY_Z));
