...
public final class MobMovementPolicy {
    ...
    public static void observeLifecycle(Mob mob) {
        ...
        } else if (fr.vanillainstincts.persistence.NbtCompat.getBoolean(mob.getPersistentData(), WAS_BABY_KEY)) {
    ...
    public static boolean wasObservedAsBaby(Mob mob) {
        return mob != null
                && fr.vanillainstincts.persistence.NbtCompat.getBoolean(mob.getPersistentData(), WAS_BABY_KEY);
    }

    public static boolean hasGrownFromBaby(Mob mob) {
        return mob != null
                && fr.vanillainstincts.persistence.NbtCompat.getBoolean(mob.getPersistentData(), GREW_UP_KEY);
    }
    ...
    public static boolean isFrightened(Mob mob, long gameTime) {
        return mob != null && gameTime < fr.vanillainstincts.persistence.NbtCompat.getLong(mob.getPersistentData(), FRIGHTENED_UNTIL_KEY);
    }
