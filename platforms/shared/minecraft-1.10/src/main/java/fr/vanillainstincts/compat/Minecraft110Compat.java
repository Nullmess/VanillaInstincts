...
public final class Minecraft110Compat {
     ...
     */
    public static Biome biome(World world, BlockPos pos) {
        ...
        return biome instanceof Biome ? (Biome) biome : plains();
    }

    private static Biome plains() {
        Biome biome = LegacyRegistry.BIOME.get(
                new ResourceLocation("minecraft:plains"));
        if (biome != null) return biome;
        for (Biome candidate : LegacyRegistry.BIOME) return candidate;
        return null;
    }
