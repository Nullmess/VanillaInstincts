...
public final class GolemPatrolController {
    ...
    public static void contribute(EntityIronGolem golem, MobDecisionPlan plan,
        ...
        Vec3d requested =fr.vanillainstincts.compat.Minecraft112Compat.add(Minecraft115VectorCompat.atBottomCenterOf(center), 
    ...
    private static Optional<BlockPos> villageCenter(EntityIronGolem golem,
        ...
        return level.getEntitiesWithinAABB(EntityVillager.class,
                        golem.getEntityBoundingBox().expandXyz(radius),
