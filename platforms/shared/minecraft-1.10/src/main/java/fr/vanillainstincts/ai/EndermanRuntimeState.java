...
public final class EndermanRuntimeState {
    ...
    public static EndermanRuntimeState load(EntityEnderman enderman) {
        ...
        state.cargoId = tag.hasUniqueId("cargo_id") ? tag.getUniqueId("cargo_id") : null;
        state.objectiveId = tag.hasUniqueId("objective_id")
                ? tag.getUniqueId("objective_id") : null;
        ...
        state.suspendedAngerTargetId = tag.hasUniqueId("suspended_anger_target")
                ? tag.getUniqueId("suspended_anger_target") : null;
    ...
    public void save(EntityEnderman enderman) {
        ...
        if (cargoId != null) {
            tag.setUniqueId("cargo_id", cargoId);
        }
        if (objectiveId != null) {
            tag.setUniqueId("objective_id", objectiveId);
        }
        if (suspendedAngerTargetId != null) {
            tag.setUniqueId("suspended_anger_target", suspendedAngerTargetId);
        }
