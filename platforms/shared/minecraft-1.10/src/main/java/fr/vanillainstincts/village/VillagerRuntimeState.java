...
public final class VillagerRuntimeState {
    ...
    public static VillagerRuntimeState load(EntityVillager villager) {
        ...
        state.reportedAggressorId = tag.hasUniqueId("reported_aggressor_id")
                ? tag.getUniqueId("reported_aggressor_id") : null;
        state.reportGolemId = tag.hasUniqueId("report_golem_id")
                ? tag.getUniqueId("report_golem_id") : null;
    ...
    public void save(EntityVillager villager) {
        ...
        if (reportedAggressorId != null) {
            tag.setUniqueId("reported_aggressor_id", reportedAggressorId);
        }
        if (reportGolemId != null) {
            tag.setUniqueId("report_golem_id", reportGolemId);
        }
