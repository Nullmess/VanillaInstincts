...
public final class CreeperBlastEvaluator {
    ...
    public static double estimatedDamage(CreeperEntity creeper,
                                         LivingEntity target) {
        ...
        Vector3d center = creeper.position().add(0.0D,
    ...
    public static boolean shouldStartFuse(CreeperEntity creeper,
                                          LivingEntity target) {
