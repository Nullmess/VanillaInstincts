...
public final class MissionZoglinTargetPolicy {
    ...
    public static boolean isMissionZoglin(
        ...
        return mob instanceof ZoglinEntity
                && state != null
    ...
    public static boolean shouldBlockAttack(
        ...
        if (!(attacker instanceof ZoglinEntity)
                || victim == null
                || !NetherReinforcementState.hasPersistentMission(((ZoglinEntity) (attacker)))) {
            return false;
        } ZoglinEntity zoglin = (ZoglinEntity) (attacker);
