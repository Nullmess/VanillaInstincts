...
public class MobActionRequest {
    ...
    public MobActionRequest(VanillaInstinctsState state, ActionOwner owner, MobActionType type, int priority, Vector3d vector, double speed, int holdTicks, Runnable onAccepted) {
