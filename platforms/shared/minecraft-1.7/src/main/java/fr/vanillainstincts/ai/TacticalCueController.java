...
public final class TacticalCueController {
    ...
    public static void onActionAccepted(EntityLiving mob, VanillaInstinctsState previousState,
        ...
        Vec3 pos =fr.vanillainstincts.compat.Minecraft112Compat.add(fr.vanillainstincts.compat.Minecraft17Compat.position(mob), 0.0D,
        ...
        if (mob instanceof EntityEnderman
            ...
            fr.vanillainstincts.compat.Minecraft17Compat.spawnParticle(level, EnumParticleTypes.VILLAGER_ANGRY,
    ...
    public static void emitEndermanDeliveryWarning(EntityEnderman enderman,
        ...
        Vec3 pos =fr.vanillainstincts.compat.Minecraft112Compat.add(fr.vanillainstincts.compat.Minecraft17Compat.position(enderman), 0.0D, 1.45D, 0.0D);
        fr.vanillainstincts.compat.Minecraft17Compat.spawnParticle(level, EnumParticleTypes.PORTAL,
    ...
    public static void emitGolemReport(EntityVillager villager, EntityIronGolem golem,
        ...
        Vec3 from =fr.vanillainstincts.compat.Minecraft112Compat.add(fr.vanillainstincts.compat.Minecraft17Compat.position(villager), 0.0D,
                villager.height + 0.2D, 0.0D);
        Vec3 to =fr.vanillainstincts.compat.Minecraft112Compat.add(fr.vanillainstincts.compat.Minecraft17Compat.position(golem), 0.0D, 1.7D, 0.0D);
    ...
    public static void emitGolemRole(EntityIronGolem golem, GolemDefenseRole role,
        ...
        Vec3 pos =fr.vanillainstincts.compat.Minecraft112Compat.add(fr.vanillainstincts.compat.Minecraft17Compat.position(golem), 0.0D,
                golem.height + 0.2D, 0.0D);
        int count = role == GolemDefenseRole.PURSUER ? 8
                : role == GolemDefenseRole.INTERCEPTOR ? 6 : 4;
        fr.vanillainstincts.compat.Minecraft17Compat.spawnParticle(level, role == GolemDefenseRole.GUARDIAN
    ...
    public static void emitVillageAlert(EntityVillager villager,
        ...
        Vec3 pos =fr.vanillainstincts.compat.Minecraft112Compat.add(fr.vanillainstincts.compat.Minecraft17Compat.position(villager), 0.0D,
