...
public final class ChildVillageAlertController {
    ...
    public static void alertWitnesses(EntityVillager attacked,
        ...
        AxisAlignedBB area = fr.vanillainstincts.compat.Minecraft112Compat.expandBox(fr.vanillainstincts.compat.Minecraft17Compat.boundingBox(attacked), 
                VillageSocialRules.CHILD_ALERT_WITNESS_RADIUS);
        for (EntityVillager child : fr.vanillainstincts.compat.Minecraft112Compat.entitiesWithinAABB(level, EntityVillager.class, area,
    ...
    public static void begin(EntityVillager child,
        ...
        fr.vanillainstincts.compat.Minecraft18NbtCompat.setUniqueId(child.getEntityData(), AGGRESSOR, threat.aggressorId());
    ...
    public static boolean contribute(EntityVillager child,
        ...
        if (mode == SEEK_ADULT) {
            ...
            if (adult == null) {
                ...
                if (adult != null) {
                    fr.vanillainstincts.compat.Minecraft18NbtCompat.setUniqueId(child.getEntityData(), ADULT, adult.getUniqueID());
                }
            }
            if (adult != null) {
                ...
                plan.offerNavigation(VanillaInstinctsState.CHILD_SEEK_ADULT,
                        ...
                        fr.vanillainstincts.compat.Minecraft17Compat.position(destination), VillageSocialRules.CHILD_ALERT_SPEED,
    ...
    private static EntityVillager nearestAdult(EntityVillager child, WorldServer level) {
        return fr.vanillainstincts.compat.Minecraft112Compat.entitiesWithinAABB(level, EntityVillager.class,
                        fr.vanillainstincts.compat.Minecraft112Compat.expandBox(fr.vanillainstincts.compat.Minecraft17Compat.boundingBox(child), 
    ...
    private static EntityVillager resolveAdult(EntityVillager child, WorldServer level) {
        if (!fr.vanillainstincts.compat.Minecraft18NbtCompat.hasUniqueId(child.getEntityData(), ADULT)) return null;
        Entity entity = fr.vanillainstincts.compat.Minecraft17Compat.getEntityFromUuid(level, fr.vanillainstincts.compat.Minecraft18NbtCompat.getUniqueId(child.getEntityData(), ADULT));
