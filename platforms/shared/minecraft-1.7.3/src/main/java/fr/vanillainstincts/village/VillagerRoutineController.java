...
public final class VillagerRoutineController {
    ...
    public static void contribute(EntityVillager villager,
        ...
        if (crowd > VillageSocialRules.VILLAGER_COMFORTABLE_CROWD) {
            ...
            if (fr.vanillainstincts.compat.Minecraft112Compat.lengthSq(direction) > 1.0E-6D) {
                Vec3 requested = fr.vanillainstincts.compat.Minecraft17Compat.position(villager).add(
    ...
    private static Vec3 separationDirection(EntityVillager villager,
        ...
        for (EntityVillager other : fr.vanillainstincts.compat.Minecraft112Compat.entitiesWithinAABB(level, EntityVillager.class,
            ...
            Vec3 delta = fr.vanillainstincts.compat.Minecraft17Compat.position(villager).subtract(fr.vanillainstincts.compat.Minecraft17Compat.position(other));
