...
public final class AnimalZombieSkeletonTacticsGameTests {
    ...
    public static void animalComfortFearPersistsAndExpires(GameTestHelper helper) {
        ...
        helper.assertTrue(AnimalComfortController.fearSource(cow, now + 1).isPresent(),
                net.minecraft.network.chat.Component.literal("La peur Animal Comfort 2.0 doit persister dans la mémoire de l'animal"));
        helper.assertTrue(AnimalComfortController.fearSource(cow,
                        now + AnimalRules.ANIMAL_FEAR_MEMORY_TICKS + 1).isEmpty(),
                net.minecraft.network.chat.Component.literal("La peur doit expirer sans devenir permanente"));
        helper.succeed();
    }
    ...
    public static void animalComfortRemembersGoodShelter(GameTestHelper helper) {
        ...
        helper.assertTrue(AnimalComfortController.rememberedShelter(cow,
                ...
                net.minecraft.network.chat.Component.literal("Un bon abri doit être mémorisé entre deux décisions"));
        helper.succeed();
    }
    ...
    public static void animalComfortStormPrefersRoof(GameTestHelper helper) {
        ...
        helper.assertTrue(roofScore > openScore + 10.0D,
                net.minecraft.network.chat.Component.literal("Sous la pluie, une zone couverte doit dominer une zone ouverte"));
        helper.succeed();
    }
    ...
    public static void animalComfortHeatPrefersShadeAndWater(GameTestHelper helper) {
        ...
        helper.assertTrue(coolScore > hotScore,
                net.minecraft.network.chat.Component.literal("En chaleur, l'ombre proche de l'eau doit être préférée"));
        helper.succeed();
    }
    ...
    public static void animalComfortPrefersAvailableSpace(GameTestHelper helper) {
        ...
        helper.assertTrue(openScore > crampedScore,
                net.minecraft.network.chat.Component.literal("Le repos doit favoriser une zone où l'animal dispose d'espace"));
        helper.succeed();
    }
    ...
    public static void animalComfortUsesHerdAnchorWhenChoosingZone(GameTestHelper helper) {
        ...
        helper.assertTrue(eastScore > westScore,
                net.minecraft.network.chat.Component.literal("À confort égal, la proximité du troupeau doit départager les zones"));
        helper.succeed();
    }
    ...
    public static void zombiePressureCountsOnlyRearAllies(GameTestHelper helper) {
        ...
        helper.assertValueEqual(rear.size(), 2,
                net.minecraft.network.chat.Component.literal("La pression doit compter les zombies derrière, pas ceux devant"));
        helper.succeed();
    }
    ...
    public static void zombiePressureMeasuresTwoBlockObstacle(GameTestHelper helper) {
        ...
        helper.assertValueEqual(ZombieHordePressureController.obstacleHeight(
                ...
                net.minecraft.network.chat.Component.literal("Une barrière de deux blocs doit être mesurée comme telle"));
        helper.succeed();
    }
    ...
    public static void zombiePressureAllowsBoundedBodyStackBoost(GameTestHelper helper) {
        ...
        helper.assertTrue(impulse.isPresent() && impulse.get().y > 0.0D,
                net.minecraft.network.chat.Component.literal("Trois zombies derrière doivent permettre un boost physique borné"));
        helper.succeed();
    }
    ...
    public static void zombiePressurePushesAtOneBlockObstacle(GameTestHelper helper) {
        ...
        helper.assertTrue(impulse.isPresent()
                ...
                net.minecraft.network.chat.Component.literal("La pression simple doit pousser sans créer un saut magique"));
        helper.succeed();
    }
    ...
    public static void zombiePressureRejectsTooHighObstacle(GameTestHelper helper) {
        ...
        helper.assertTrue(impulse.isEmpty(),
                net.minecraft.network.chat.Component.literal("La horde ne doit jamais former une tour absurde au-delà de la limite"));
        helper.succeed();
    }
    ...
    public static void zombiePressureRearScanIsBounded(GameTestHelper helper) {
        ...
        helper.assertTrue(rear.size() <= ZombieRules.PRESSURE_MAX_REAR_ALLIES,
                net.minecraft.network.chat.Component.literal("Le calcul de pression doit borner le nombre d'alliés retenus"));
        helper.succeed();
    }
    ...
    public static void skeletonFireRateDependsOnDistance(GameTestHelper helper) {
        ...
        helper.assertTrue(ideal < close && ideal < far,
                net.minecraft.network.chat.Component.literal("Le squelette doit tirer plus volontiers à sa distance préférée"));
    ...
    public static void skeletonDetectsCorner(GameTestHelper helper) {
        ...
        helper.assertTrue(SkeletonTacticsController.isCornered(skeleton, level),
                net.minecraft.network.chat.Component.literal("Deux faces bloquées doivent déclencher la sortie de coin"));
        helper.succeed();
    }
    ...
    public static void skeletonRetreatRefusesVoidLedge(GameTestHelper helper) {
        ...
        helper.assertTrue(retreat.isEmpty(),
                net.minecraft.network.chat.Component.literal("Un squelette ne doit pas reculer volontairement dans le vide"));
        helper.succeed();
    }
    ...
    public static void skeletonRetreatAvoidsLava(GameTestHelper helper) {
        ...
        helper.assertTrue(retreat.isPresent(),
                net.minecraft.network.chat.Component.literal("Le squelette doit chercher une autre voie lorsque le recul direct est dangereux"));
        ...
        helper.assertFalse(level.getFluidState(chosenFloor).is(FluidTags.LAVA),
                net.minecraft.network.chat.Component.literal("La destination de recul ne doit pas être dans la lave"));
        helper.succeed();
    }
    ...
    public static void skeletonStrafeKeepsSafeLineOfFire(GameTestHelper helper) {
        ...
        helper.assertTrue(strafe.isPresent(),
                net.minecraft.network.chat.Component.literal("Un terrain ouvert doit offrir une position de strafe sûre"));
        helper.assertTrue(SkeletonTacticsController.hasLineOfFire(skeleton,
                        target, level, strafe.get()),
                net.minecraft.network.chat.Component.literal("La position choisie doit conserver une vraie ligne de tir"));
        helper.succeed();
    }
    ...
    public static void skeletonLaneBiasIsStableAndLimited(GameTestHelper helper) {
        ...
        helper.assertValueEqual(first, second,
                net.minecraft.network.chat.Component.literal("Le couloir tactique individuel doit rester stable"));
        helper.assertTrue(Math.abs(first) <= 1.6D,
                net.minecraft.network.chat.Component.literal("La coopération doit rester limitée et ne pas former une conscience collective"));
        helper.succeed();
    }
