...
public final class AdaptiveSkeletonProgressionGameTests {
    ...
    public static void promotionRequiresAdvancement(GameTestHelper helper) {
        helper.assertFalse(SniperSkeletonController.shouldPromote(
                        false, true, 0, 0.0D),
                net.minecraft.network.chat.Component.literal("L'avancement doit être obligatoire"));
        helper.succeed();
    }
    ...
    public static void promotionRequiresNaturalSpawn(GameTestHelper helper) {
        helper.assertFalse(SniperSkeletonController.shouldPromote(
                        true, false, 0, 0.0D),
                net.minecraft.network.chat.Component.literal("Un squelette artificiel ne doit pas être promu"));
        helper.succeed();
    }
    ...
    public static void promotionHonorsLocalLimit(GameTestHelper helper) {
        helper.assertFalse(SniperSkeletonController.shouldPromote(
                ...
                net.minecraft.network.chat.Component.literal("Le plafond local doit être respecté"));
        helper.succeed();
    }
    ...
    public static void promotionAcceptsLowRoll(GameTestHelper helper) {
        helper.assertTrue(SniperSkeletonController.shouldPromote(
                        true, true, 0, 0.0D),
                net.minecraft.network.chat.Component.literal("Un tirage valide doit promouvoir le squelette"));
        helper.succeed();
    }
    ...
    public static void promotionRejectsBoundaryRoll(GameTestHelper helper) {
        helper.assertFalse(SniperSkeletonController.shouldPromote(
                ...
                net.minecraft.network.chat.Component.literal("La borne supérieure doit être exclusive"));
        helper.succeed();
    }
    ...
    public static void customShotStartsAtFiftyBlocks(
        ...
        helper.assertTrue(SniperSkeletonController.canCustomShoot(
                        range * range, true),
                net.minecraft.network.chat.Component.literal("Le tir longue portée doit commencer à cinquante blocs"));
        helper.succeed();
    }
    ...
    public static void customShotAcceptsMaximumRange(GameTestHelper helper) {
        ...
        helper.assertTrue(SniperSkeletonController.canCustomShoot(
                        range * range, true),
                net.minecraft.network.chat.Component.literal("Le tir doit rester possible à la portée maximale"));
        helper.succeed();
    }
    ...
    public static void customShotRejectsBeyondMaximumRange(
        ...
        helper.assertFalse(SniperSkeletonController.canCustomShoot(
                        range * range, true),
                net.minecraft.network.chat.Component.literal("Le tir doit s'arrêter après la portée maximale"));
        helper.succeed();
    }
    ...
    public static void customShotRequiresLineOfSight(GameTestHelper helper) {
        helper.assertFalse(SniperSkeletonController.canCustomShoot(
                        900.0D, false),
                net.minecraft.network.chat.Component.literal("Le squelette ne doit pas tirer à travers les murs"));
        helper.succeed();
    }
    ...
    public static void leadRemainsBounded(GameTestHelper helper) {
        helper.assertTrue(SniperSkeletonController.leadTicks(500.0D)
                ...
                net.minecraft.network.chat.Component.literal("L'anticipation doit rester bornée"));
        helper.succeed();
    }
    ...
    public static void promotionPersistsOwner(GameTestHelper helper) {
        ...
        helper.assertTrue(SniperSkeletonController.isSniper(skeleton),
                net.minecraft.network.chat.Component.literal("Le marqueur tireur doit être persistant"));
        helper.assertTrue(owner.equals(
                        SniperSkeletonController.targetId(skeleton)),
                net.minecraft.network.chat.Component.literal("Le joueur déclencheur doit être conservé"));
        helper.succeed();
    }
    ...
    public static void advancementIdUsesVanillaSniperDuel(
        ...
        helper.assertValueEqual(
                ...
                net.minecraft.network.chat.Component.literal("Le bon avancement vanilla doit être utilisé"));
        helper.succeed();
    }
}
