...
public final class VillageTemplateSelectionGameTests {
    ...
    public static void unusedTemplatesComeFirst(GameTestHelper helper) {
        ...
        helper.assertTrue(order.equals(List.of(1)),
                net.minecraft.network.chat.Component.literal("Le modèle inédit doit être prioritaire"));
        helper.succeed();
    }
    ...
    public static void allUsedContinuesBalancedGrowth(GameTestHelper helper) {
        ...
        helper.assertTrue(order.equals(List.of(0, 1)),
                net.minecraft.network.chat.Component.literal("Le cycle doit reprendre avec les modèles les moins utilisés"));
        helper.succeed();
    }
    ...
    public static void housingFiltersNonHousing(GameTestHelper helper) {
        List<Integer> order = VillageTemplateSelectionPolicy.order(
                ...
                true, 0L, 6);
        helper.assertTrue(order.equals(List.of(1)),
                net.minecraft.network.chat.Component.literal("Une urgence de lits doit choisir une maison"));
        helper.succeed();
    }
    ...
    public static void housingUsesLeastRepeatedModel(GameTestHelper helper) {
        List<Integer> order = VillageTemplateSelectionPolicy.order(
                ...
                true, 0L, 6);
        helper.assertTrue(order.equals(List.of(1)),
                net.minecraft.network.chat.Component.literal("La maison la moins répétée doit être choisie"));
        helper.succeed();
    }
    ...
    public static void selectorIsDeterministic(GameTestHelper helper) {
        ...
        helper.assertTrue(first.equals(second),
                net.minecraft.network.chat.Component.literal("La rotation doit rester déterministe"));
        helper.succeed();
    }
    ...
    public static void selectorRotatesCandidates(GameTestHelper helper) {
        ...
        helper.assertFalse(first.equals(second),
                net.minecraft.network.chat.Component.literal("Le sélecteur doit répartir les modèles"));
        helper.succeed();
    }
    ...
    public static void limitBoundsSiteAttempts(GameTestHelper helper) {
        ...
        helper.assertValueEqual(order.size(), 2,
                net.minecraft.network.chat.Component.literal("Le budget de modèles doit être borné"));
        helper.succeed();
    }
    ...
    public static void orderContainsNoDuplicate(GameTestHelper helper) {
        ...
        helper.assertValueEqual(new HashSet<>(order).size(), order.size(),
                net.minecraft.network.chat.Component.literal("Un modèle ne doit apparaître qu'une fois par audit"));
        helper.succeed();
    }
    ...
    public static void negativeUsageIsNormalized(GameTestHelper helper) {
        ...
        helper.assertTrue(order.equals(List.of(0)),
                net.minecraft.network.chat.Component.literal("Une ancienne valeur négative doit être traitée comme zéro"));
        helper.succeed();
    }
    ...
    public static void missingHousingTemplateReturnsEmpty(
        ...
        helper.assertTrue(order.isEmpty(),
                net.minecraft.network.chat.Component.literal("Aucun faux logement ne doit être sélectionné"));
        helper.succeed();
    }
    ...
    public static void invalidArraysReturnEmpty(GameTestHelper helper) {
        ...
        helper.assertTrue(order.isEmpty(),
                net.minecraft.network.chat.Component.literal("Une entrée incohérente doit être refusée"));
        helper.succeed();
    }
    ...
    public static void zeroLimitReturnsEmpty(GameTestHelper helper) {
        ...
        helper.assertTrue(order.isEmpty(),
                net.minecraft.network.chat.Component.literal("Un budget nul ne doit lancer aucun audit"));
        helper.succeed();
    }
}
