...
public final class RuntimeDiagnosticsGameTests {
    ...
    public static void healthySnapshotIsHealthy(GameTestHelper helper) {
        ...
        helper.assertTrue(report.healthy(),
                net.minecraft.network.chat.Component.literal("Un instantané nominal doit être sain"));
        helper.succeed();
    }
    ...
    public static void missingSnapshotIsUnhealthy(GameTestHelper helper) {
        ...
        helper.assertValueEqual(report.health(), HealthLevel.UNHEALTHY,
                net.minecraft.network.chat.Component.literal("Un diagnostic sans instantané doit échouer clairement"));
        helper.succeed();
    }
    ...
    public static void slowTickProducesWarning(GameTestHelper helper) {
        ...
        helper.assertTrue(hasCode(report, "scheduler.tick_slow"),
                net.minecraft.network.chat.Component.literal("Un tick lent doit être visible dans le diagnostic"));
        helper.succeed();
    }
    ...
    public static void overloadTickProducesWarning(GameTestHelper helper) {
        ...
        helper.assertTrue(hasCode(report, "scheduler.tick_overload"),
                net.minecraft.network.chat.Component.literal("Une surcharge doit utiliser un code stable"));
        helper.succeed();
    }
    ...
    public static void costBudgetOverflowIsError(GameTestHelper helper) {
        ...
        helper.assertValueEqual(report.health(), HealthLevel.UNHEALTHY,
                net.minecraft.network.chat.Component.literal("Le dépassement du budget logique doit être une erreur"));
        helper.succeed();
    }
    ...
    public static void timeBudgetOverflowIsWarning(GameTestHelper helper) {
        ...
        helper.assertTrue(hasCode(report, "scheduler.time_budget_exceeded"),
                net.minecraft.network.chat.Component.literal("Un dépassement temporel simple doit être signalé"));
        helper.succeed();
    }
    ...
    public static void severeTimeOverflowIsError(GameTestHelper helper) {
        ...
        helper.assertTrue(hasCode(report, "scheduler.time_budget_severe"),
                net.minecraft.network.chat.Component.literal("Un dépassement temporel extrême doit être une erreur"));
        helper.succeed();
    }
    ...
    public static void rejectionPressureIsWarning(GameTestHelper helper) {
        ...
        helper.assertTrue(hasCode(report, "scheduler.rejection_pressure"),
                net.minecraft.network.chat.Component.literal("Un quart de refus doit être diagnostiqué"));
        helper.succeed();
    }
    ...
    public static void severeRejectionIsError(GameTestHelper helper) {
        ...
        helper.assertTrue(hasCode(report, "scheduler.rejection_severe"),
                net.minecraft.network.chat.Component.literal("Trois quarts de refus doivent être une erreur"));
        helper.succeed();
    }
    ...
    public static void orphanReservationIsError(GameTestHelper helper) {
        ...
        helper.assertTrue(hasCode(evaluate(snapshot),
                ...
                net.minecraft.network.chat.Component.literal("Une réservation orpheline doit être une erreur"));
        helper.succeed();
    }
    ...
    public static void staleOperationIsWarning(GameTestHelper helper) {
        ...
        helper.assertTrue(hasCode(evaluate(snapshot),
                ...
                net.minecraft.network.chat.Component.literal("Une opération ancienne doit être diagnostiquée"));
        helper.succeed();
    }
    ...
    public static void trackedEntityCeilingIsWarning(GameTestHelper helper) {
        ...
        helper.assertTrue(hasCode(evaluate(snapshot),
                ...
                net.minecraft.network.chat.Component.literal("Un cache d'entités trop grand doit être signalé"));
        helper.succeed();
    }
    ...
    public static void surfaceCacheCeilingIsWarning(GameTestHelper helper) {
        ...
        helper.assertTrue(hasCode(evaluate(snapshot),
                ...
                net.minecraft.network.chat.Component.literal("Un cache de surfaces trop grand doit être signalé"));
        helper.succeed();
    }
    ...
    public static void temporaryBlockCeilingIsWarning(
        ...
        helper.assertTrue(hasCode(evaluate(snapshot),
                ...
                net.minecraft.network.chat.Component.literal("Un registre temporaire trop grand doit être signalé"));
        helper.succeed();
    }
    ...
    public static void boundedLogKeepsNewestEntries(GameTestHelper helper) {
        ...
        helper.assertValueEqual(log.size(), 2,
                net.minecraft.network.chat.Component.literal("Le journal doit rester borné"));
        helper.assertValueEqual(log.snapshot().getFirst().code(), "two",
                net.minecraft.network.chat.Component.literal("Le plus ancien diagnostic doit être retiré"));
        helper.succeed();
    }
    ...
    public static void masterStartsGrandMasterProgress(
        ...
        helper.assertFalse(VillagerGrandMasterController
                ...
                net.minecraft.network.chat.Component.literal("Un maître récent ne doit pas être promu immédiatement"));
        helper.assertValueEqual(VillagerGrandMasterController
                        .masterTradeCount(villager), 0,
                net.minecraft.network.chat.Component.literal("Le compteur doit commencer à zéro"));
        helper.assertValueEqual(VillagerGrandMasterController
                        .masterSinceDay(villager), 100L,
                net.minecraft.network.chat.Component.literal("L'ancienneté de maître doit être mémorisée"));
        helper.assertValueEqual(VillagerGrandMasterController
                        .progress(villager, 100L), 0.0F,
                net.minecraft.network.chat.Component.literal("La barre visible doit commencer vide"));
        helper.assertTrue(FarmerLivestockController.shouldBreed(7),
                net.minecraft.network.chat.Component.literal("Un troupeau sous la cible doit encore pouvoir se reproduire"));
        helper.assertFalse(FarmerLivestockController.shouldBreed(8),
                net.minecraft.network.chat.Component.literal("La reproduction doit s'arrêter à la population cible"));
        helper.assertFalse(FarmerLivestockController.shouldCull(12),
                net.minecraft.network.chat.Component.literal("Le plafond autorisé ne doit pas déclencher d'abattage"));
        helper.assertTrue(FarmerLivestockController.shouldCull(13),
                net.minecraft.network.chat.Component.literal("L'excédent au-dessus du plafond doit être régulé"));
        helper.assertValueEqual(ClericNetherExpeditionController
                        .requiredPortalObsidian(), 10,
                net.minecraft.network.chat.Component.literal("Un cadre minimal sans coins doit consommer dix obsidiennes"));
        int duration = ClericNetherExpeditionController.virtualDuration(42L);
        helper.assertTrue(duration >= 6_000 && duration <= 12_000,
                net.minecraft.network.chat.Component.literal("Une expédition simulée doit durer entre cinq et dix minutes"));
        helper.succeed();
    }
    ...
    public static void twentyThreeTradesDoNotPromote(
        ...
        helper.assertFalse(VillagerGrandMasterController
                        .isGrandMaster(villager),
                net.minecraft.network.chat.Component.literal("Vingt-trois échanges ne doivent pas suffire"));
        helper.assertValueEqual(VillagerGrandMasterController
                        .masterTradeCount(villager), 23,
                net.minecraft.network.chat.Component.literal("La progression doit conserver chaque échange de maître"));
        helper.assertTrue(VillagerGrandMasterController
                        .progress(villager, 103L) > 0.95F,
                net.minecraft.network.chat.Component.literal("La barre doit montrer une progression presque complète"));
        helper.assertTrue(VillagerGrandMasterController
                        .progress(villager, 103L) < 1.0F,
                net.minecraft.network.chat.Component.literal("La barre ne doit être pleine qu'après la promotion"));
        helper.succeed();
    }
    ...
    public static void grandMasterUsesNetheriteMarkerAndKeepsLevelFive(
        ...
        helper.assertTrue(VillagerGrandMasterController
                        .isGrandMaster(villager),
                net.minecraft.network.chat.Component.literal("Le vingt-quatrième échange de maître doit promouvoir immédiatement"));
        helper.assertFalse(VillagerGrandMasterController
                        .maintain(villager, helper.getLevel(), 103L),
                net.minecraft.network.chat.Component.literal("Un Grand Maître déjà promu ne doit pas être promu une seconde fois"));
        helper.assertTrue(VillagerGrandMasterController
                        .isGrandMaster(villager),
                net.minecraft.network.chat.Component.literal("Le rang Grand Maître doit être persistant"));
        helper.assertTrue(VillagerGrandMasterController
                        .hasNetheriteMarker(villager),
                net.minecraft.network.chat.Component.literal("Le marqueur synchronisé doit afficher l'insigne netherite"));
        helper.assertTrue(((GrandMasterSyncedData) villager)
                        .vanillainstincts$isGrandMasterSynced(),
                net.minecraft.network.chat.Component.literal("Le bit client Grand Maître doit être synchronisé"));
        helper.assertValueEqual(villager.getVillagerData().level(), 5,
                net.minecraft.network.chat.Component.literal("Le rang moddé ne doit jamais créer un niveau vanilla 6"));
        helper.assertValueEqual(VillagerGrandMasterController
                        .progress(villager, 103L), 1.0F,
                net.minecraft.network.chat.Component.literal("La barre doit être pleine pour un Grand Maître"));
        helper.succeed();
    }
    ...
    public static void grandMasterKeepsProfessionalMemoryLonger(
        ...
        apprentice.setVillagerData(apprentice.getVillagerData()
                .withProfession(net.minecraft.core.registries.BuiltInRegistries.VILLAGER_PROFESSION.get(VillagerProfession.LIBRARIAN).orElseThrow()).withLevel(2));
        ...
        helper.assertTrue(VillagerGrandMasterIntelligenceController
                ...
                net.minecraft.network.chat.Component.literal("Un Grand Maître doit retenir son poste plus longtemps"));
        helper.assertValueEqual(VillagerGrandMasterIntelligenceController
                        .jobMemoryTicks(apprentice),
                VillageSocialRules.VILLAGER_POI_CACHE_TICKS,
                net.minecraft.network.chat.Component.literal("La mémoire standard des autres villageois ne doit pas changer"));
        helper.succeed();
    }
    ...
    public static void grandMasterMentorTransfersJobKnowledge(
        ...
        Villager apprentice = helper.spawn(EntityType.VILLAGER,
                new BlockPos(3, 1, 2));
        apprentice.setVillagerData(apprentice.getVillagerData()
                .withProfession(net.minecraft.core.registries.BuiltInRegistries.VILLAGER_PROFESSION.get(VillagerProfession.BUTCHER).orElseThrow()).withLevel(2));
        ...
        helper.assertTrue(assignedAt >= 0L,
                net.minecraft.network.chat.Component.literal("Le Grand Maître doit sélectionner son apprenti proche "
                        + "sans interférence entre GameTests"));
        helper.assertValueEqual(
                VillagerGrandMasterIntelligenceController.mentorId(
                        apprentice, assignedAt), grandMaster.getUUID(),
                net.minecraft.network.chat.Component.literal("L'apprenti doit conserver le Grand Maître attendu comme mentor"));
        ...
        helper.assertTrue(learnedJob.equals(
                ...
                net.minecraft.network.chat.Component.literal("Un apprenti proche doit apprendre le poste connu du mentor"));
        helper.assertValueEqual(VillagerGrandMasterIntelligenceController
                        .lessonCount(apprentice), 1,
                net.minecraft.network.chat.Component.literal("Une session ne doit transmettre la connaissance qu'une fois"));
        helper.succeed();
    }
    ...
    public static void grandMasterMentorsOnlySameProfession(
        ...
        farmer.setVillagerData(farmer.getVillagerData()
                .withProfession(net.minecraft.core.registries.BuiltInRegistries.VILLAGER_PROFESSION.get(VillagerProfession.FARMER).orElseThrow()).withLevel(2));
        helper.assertFalse(VillagerGrandMasterIntelligenceController
                        .isEligibleApprentice(grandMaster, farmer),
                net.minecraft.network.chat.Component.literal("Un Grand Maître ne doit former que son propre métier"));
        helper.succeed();
    }
    ...
    public static void invalidGrandMasterRankIsRemoved(
        ...
        helper.assertFalse(VillagerGrandMasterController
                        .isGrandMaster(villager),
                net.minecraft.network.chat.Component.literal("Un villageois qui n'est plus maître doit perdre le rang"));
        helper.assertFalse(VillagerGrandMasterController
                        .hasNetheriteMarker(villager),
                net.minecraft.network.chat.Component.literal("L'insigne netherite doit disparaître avec le rang invalide"));
        helper.assertValueEqual(VillagerGrandMasterController
                        .masterTradeCount(villager), 0,
                net.minecraft.network.chat.Component.literal("Une progression incohérente doit être supprimée"));
        helper.succeed();
    }
    ...
    public static void serviceCreatesLevelSnapshot(GameTestHelper helper) {
        ...
        helper.assertTrue(RuntimeDiagnosticsService.latestSnapshot(level)
                        != null,
                net.minecraft.network.chat.Component.literal("Le service doit produire un instantané sans scanner le monde"));
        RuntimeDiagnosticsService.clearLevel(level);
        helper.succeed();
    }
    ...
    public static void serviceKeepsBoundedHistory(GameTestHelper helper) {
        ...
        helper.assertTrue(RuntimeDiagnosticsService.recent(level).size()
                        <= 64,
                net.minecraft.network.chat.Component.literal("L'historique de production doit rester borné"));
        RuntimeDiagnosticsService.clearLevel(level);
        helper.succeed();
    }
    ...
    public static void serviceClearsOnLevelUnload(GameTestHelper helper) {
        ...
        helper.assertTrue(RuntimeDiagnosticsService.latestSnapshot(level)
                        == null,
                net.minecraft.network.chat.Component.literal("Le diagnostic ne doit pas retenir un niveau déchargé"));
        helper.assertTrue(RuntimeDiagnosticsService.recent(level).isEmpty(),
                net.minecraft.network.chat.Component.literal("L'historique doit être libéré avec le niveau"));
        helper.succeed();
    }
    ...
    public static void perceptionNoiseCreatesAndExpiresMemory(
        ...
        helper.assertTrue(MobPerceptionMemory.bestKnownPosition(zombie,
                ...
                net.minecraft.network.chat.Component.literal("Un bruit proche doit être mémorisé"));
        helper.assertTrue(MobPerceptionMemory.bestKnownPosition(zombie,
                        level.getGameTime() + 41L).isEmpty(),
                net.minecraft.network.chat.Component.literal("La mémoire sonore doit expirer"));
        helper.succeed();
    }
    ...
    public static void zombieToolUseRequiresSuitableHeldTool(
        ...
        helper.assertFalse(ZombieTacticsController.canBreakWithHeldTool(
                        zombie, level, stone),
                net.minecraft.network.chat.Component.literal("Un zombie à mains nues ne doit pas miner"));
        zombie.setItemInHand(InteractionHand.MAIN_HAND,
                new ItemStack(Items.WOODEN_PICKAXE));
        helper.assertTrue(ZombieTacticsController.canBreakWithHeldTool(
                        zombie, level, stone),
                net.minecraft.network.chat.Component.literal("Un outil réellement adapté doit autoriser le passage"));
        helper.succeed();
    }
    ...
    public static void skeletonRetreatIncreasesDistance(
        ...
        helper.assertTrue(retreat.distanceToSqr(target.position()) > before,
                net.minecraft.network.chat.Component.literal("Le repositionnement proche doit augmenter la distance"));
        helper.succeed();
    }
    ...
    public static void pillagerSquadUsesDifferentFlankSlots(
        ...
        helper.assertTrue(a.distanceToSqr(b) > 0.25D,
                net.minecraft.network.chat.Component.literal("Deux pillards doivent pouvoir choisir des slots distincts"));
        helper.succeed();
    }
    ...
    public static void animalComfortFindsRoofedPosition(
        ...
        helper.assertTrue(AnimalComfortController.findShelter(cow, level)
                        .isPresent(),
                net.minecraft.network.chat.Component.literal("Un animal doit repérer un abri proche sous un toit"));
        helper.succeed();
    }
    ...
    public static void villagerProfessionPathBiasesFarmland(
        ...
        librarian.setVillagerData(librarian.getVillagerData()
                .withProfession(net.minecraft.core.registries.BuiltInRegistries.VILLAGER_PROFESSION.get(VillagerProfession.LIBRARIAN).orElseThrow()));
        ...
        helper.assertTrue(farmerBias > librarianBias,
                net.minecraft.network.chat.Component.literal("Le fermier doit préférer les rangées agricoles aux autres métiers"));
        helper.succeed();
    }
    ...
    private static Villager masterVillager(GameTestHelper helper,
        ...
        villager.setVillagerData(villager.getVillagerData()
                .withProfession(net.minecraft.core.registries.BuiltInRegistries.VILLAGER_PROFESSION.get(profession).orElseThrow())
                .withLevel(5));
        return villager;
    }
