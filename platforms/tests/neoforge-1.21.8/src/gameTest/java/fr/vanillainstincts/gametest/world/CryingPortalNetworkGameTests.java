...
public final class CryingPortalNetworkGameTests {
    ...
    public static void cryingNetworkIsSeparatedFromVanilla(GameTestHelper helper) {
        helper.assertTrue(CryingObsidianPortalController
                ...
                net.minecraft.network.chat.Component.literal("Le réseau pleureur doit rester hors du rayon vanilla"));
        helper.succeed();
    }
    ...
    public static void cryingTargetUsesDedicatedLane(GameTestHelper helper) {
        ...
        helper.assertValueEqual(crying - vanilla,
                ...
                net.minecraft.network.chat.Component.literal("La sortie pleureuse doit utiliser la voie dédiée"));
        helper.succeed();
    }
    ...
    public static void nearbySourcesMayReuseOneDestination(GameTestHelper helper) {
        helper.assertTrue(CryingObsidianPortalController
                ...
                net.minecraft.network.chat.Component.literal("Deux portails proches doivent pouvoir partager une sortie"));
        helper.succeed();
    }
    ...
    public static void distantSourcesKeepSeparateDestinations(GameTestHelper helper) {
        helper.assertTrue(!CryingObsidianPortalController
                ...
                net.minecraft.network.chat.Component.literal("Deux portails très éloignés ne doivent pas être fusionnés"));
        helper.succeed();
    }
    ...
    public static void cryingXRoundTripKeepsCoordinate(GameTestHelper helper) {
        ...
        helper.assertValueEqual(CryingObsidianPortalController
                ...
                net.minecraft.network.chat.Component.literal("Le décalage réservé doit être réversible"));
        helper.succeed();
    }
    ...
    public static void cryingZKeepsVanillaRatio(GameTestHelper helper) {
        ...
        helper.assertValueEqual(CryingObsidianPortalController
                ...
                net.minecraft.network.chat.Component.literal("L'axe Z doit conserver le rapport vanilla 8:1"));
        helper.succeed();
    }
    ...
    public static void xFrameHasCanonicalOuterBase(GameTestHelper helper) {
        ...
        helper.assertValueEqual(CryingObsidianPortalController
                ...
                net.minecraft.network.chat.Component.literal("Le cadre X doit posséder une base canonique stable"));
        helper.succeed();
    }
    ...
    public static void zFrameHasCanonicalOuterBase(GameTestHelper helper) {
        ...
        helper.assertValueEqual(CryingObsidianPortalController
                ...
                net.minecraft.network.chat.Component.literal("Le cadre Z doit posséder une base canonique stable"));
        helper.succeed();
    }
    ...
    public static void activeDestinationIsReused(GameTestHelper helper) {
        ...
        helper.assertTrue(CryingObsidianPortalController.isReusablePortal(
                ...
                net.minecraft.network.chat.Component.literal("Une sortie active doit être réutilisée sans replacer ses blocs"));
        helper.succeed();
    }
    ...
    public static void occupiedDestinationCannotBeOverwritten(GameTestHelper helper) {
        ...
        helper.assertTrue(!CryingObsidianPortalController.portalSiteClear(
                        helper.getLevel(), base, Direction.Axis.X),
                net.minecraft.network.chat.Component.literal("Un cadre existant ne doit jamais être considéré comme libre"));
        helper.succeed();
    }
    ...
    public static void severalSourcesCanShareStoredDestination(GameTestHelper helper) {
        ...
        helper.assertTrue(data.linkCount() == 2
                ...
                net.minecraft.network.chat.Component.literal("Le partage d'une sortie ne doit pas dupliquer le portail"));
        helper.succeed();
    }
    ...
    public static void relinkingSourceDoesNotDuplicateRecord(GameTestHelper helper) {
        ...
        helper.assertTrue(data.linkCount() == 1
                ...
                net.minecraft.network.chat.Component.literal("Mettre à jour un lien ne doit jamais créer un doublon"));
        helper.succeed();
    }
