...
/** 1.21.10 registry bridge for the Vanilla Instincts GameTest methods. */
public final class VanillaInstinctsGameTestBootstrap {
    ...
    public static void register(BusGroup modBusGroup) {
        RegisterEvent.getBus(modBusGroup)
                .addListener(VanillaInstinctsGameTestBootstrap::onRegister);
    }
    ...
    private static void onRegister(RegisterEvent event) {
        event.register(Registries.TEST_FUNCTION, registry -> {
            ...
            VanillaInstincts.LOGGER.info(
                    "Registered {} Vanilla Instincts 1.21.10 GameTest functions", count[0]);
        });
    }
