...
public final class VanillaInstinctsServerConfig {
    ...
    private static final EnumMap<FeatureFlag, ModConfigSpec.BooleanValue>
            FEATURES = new EnumMap<>(FeatureFlag.class);

    private static final ModConfigSpec.BooleanValue ENABLED;
    private static final ModConfigSpec.BooleanValue ALLOW_WORLD_CHANGES;
    private static final ModConfigSpec.BooleanValue ALLOW_ITEM_CHANGES;
    private static final ModConfigSpec.BooleanValue RESPECT_MOB_GRIEFING;
    private static final ModConfigSpec.BooleanValue PROTECT_SPAWN_AREA;
    ...
    private static final ModConfigSpec.IntValue PERMISSION_DENIED_RETRY_TICKS;
    private static final ModConfigSpec.EnumValue<GameplayProfile> PROFILE;
    private static final ModConfigSpec.EnumValue<DifficultyTier>
            MINIMUM_HOSTILE_DIFFICULTY;

    private static final ModConfigSpec.DoubleValue CHANCE_MULTIPLIER;
    private static final ModConfigSpec.DoubleValue DISTANCE_MULTIPLIER;
    private static final ModConfigSpec.DoubleValue COOLDOWN_MULTIPLIER;
    private static final ModConfigSpec.DoubleValue HOSTILE_STRENGTH_MULTIPLIER;
    private static final ModConfigSpec.DoubleValue VILLAGE_ACTIVITY_MULTIPLIER;
    private static final ModConfigSpec.DoubleValue CONSTRUCTION_RATE_MULTIPLIER;
    private static final ModConfigSpec.DoubleValue PRODUCTION_RATE_MULTIPLIER;
    private static final ModConfigSpec.DoubleValue ANIMAL_ACTIVITY_MULTIPLIER;

    private static final ModConfigSpec.IntValue CREEPER_TACTICS_MIN_Y;
    private static final ModConfigSpec.IntValue CREEPER_TACTICS_MAX_Y;
    private static final ModConfigSpec.BooleanValue CREEPER_EXPLOSION_FIRE;

    private static final ModConfigSpec.BooleanValue POSSESSION_ENABLED;
    private static final ModConfigSpec.BooleanValue POSSESSION_MODDED_MOBS;
    private static final ModConfigSpec.BooleanValue POSSESSION_INVENTORY;
    private static final ModConfigSpec.BooleanValue POSSESSION_ABILITIES;
    private static final ModConfigSpec.DoubleValue POSSESSION_RANGED_RANGE;

    private static final ModConfigSpec.IntValue DECISION_INTERVAL_TICKS;
    private static final ModConfigSpec.IntValue MAX_DECISION_COST;
    private static final ModConfigSpec.DoubleValue MAX_AI_MILLIS;
    private static final ModConfigSpec.IntValue HEAVY_TASK_GAP_MILLIS;
    private static final ModConfigSpec.BooleanValue ADAPTIVE_LOAD_SHEDDING;
    private static final ModConfigSpec.DoubleValue TARGET_TICK_MILLIS;
    private static final ModConfigSpec.DoubleValue OVERLOAD_TICK_MILLIS;
    private static final ModConfigSpec.IntValue LOAD_RECOVERY_SAMPLES;
    private static final ModConfigSpec.DoubleValue MINIMUM_BUDGET_FACTOR;
    private static final ModConfigSpec.DoubleValue URGENT_BUDGET_RESERVE;

    private static final ModConfigSpec.IntValue VILLAGE_GROWTH_MAX_PER_DAY;
    private static final ModConfigSpec.IntValue VILLAGE_SITE_SEARCH_LIMIT;
    private static final ModConfigSpec.IntValue VILLAGE_BUILD_RADIUS;
    private static final ModConfigSpec.IntValue SOCIAL_EXCHANGE_DAILY_LIMIT;
    private static final ModConfigSpec.DoubleValue SNIPER_SPAWN_CHANCE;
    private static final ModConfigSpec.DoubleValue SNIPER_MAX_RANGE;
    private static final ModConfigSpec.IntValue SNIPER_LOCAL_LIMIT;
    private static final ModConfigSpec.IntValue NETHER_MAX_MEMBERS;
    private static final ModConfigSpec.IntValue CARTOGRAPHER_TREASURE_RATE;
    ...
    static {
        ...
        RESPECT_MOB_GRIEFING = builder.comment(
                        "Require the vanilla mobGriefing rule and NeoForge mob-griefing permission.")
    ...
    private static void defineFeature(ModConfigSpec.Builder builder,
    ...
    public static boolean creeperTacticsAllowedAtY(int y) {
        int minimum = Math.min(CREEPER_TACTICS_MIN_Y.get(),
                CREEPER_TACTICS_MAX_Y.get());
        int maximum = Math.max(CREEPER_TACTICS_MIN_Y.get(),
                CREEPER_TACTICS_MAX_Y.get());
        return y >= minimum && y <= maximum;
    }

    public static boolean creeperExplosionFireEnabled() {
        return CREEPER_EXPLOSION_FIRE.get();
    }

    public static boolean possessionEnabled() {
        return POSSESSION_ENABLED.get();
    }

    public static boolean possessionModdedMobsEnabled() {
        return POSSESSION_MODDED_MOBS.get();
    }

    public static boolean possessionInventoryEnabled() {
        return POSSESSION_INVENTORY.get();
    }

    public static boolean possessionAbilitiesEnabled() {
        return POSSESSION_ABILITIES.get();
    }

    public static double possessionRangedRange() {
        return POSSESSION_RANGED_RANGE.get();
    }
