...
public final class CombatEvents {
    ...
    public static void onProjectileImpact(ProjectileImpactEvent event) {
        ...
        if (projectile.world instanceof WorldServer) {
            WorldServer perceptionLevel = (WorldServer) projectile.world;
    ...
    public static void onLivingDeath(LivingDeathEvent event) {
        ...
        if (event.getEntity() instanceof PillagerEntity) {
            ...
            if (pillager.world instanceof WorldServer) {
                WorldServer level = (WorldServer) pillager.world;
        ...
        if (event.getEntity() instanceof EntityPlayerMP) { EntityPlayerMP player = (EntityPlayerMP) (event.getEntity()); 
            if (event.getSource().getEntity() instanceof EntityIronGolem
                    ...
                    player.world)) { EntityIronGolem golem = (EntityIronGolem) (event.getSource().getEntity()); 
