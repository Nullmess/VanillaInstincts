...
public final class VanillaInstincts {
    ...
    public void init(FMLInitializationEvent event) {
        LOGGER.info("Vanilla Instincts {} ({}) initialised for Forge 1.7.9",
                VERSION, BUILD_ID);
    }
