...
public final class CreeperPassageController {
    ...
    public static Optional<BlockPos> findPassageObstacle(CreeperEntity creeper,
        ...
        Vec3d horizontal = destination.subtract(creeper.position())
    ...
    public static boolean canOpenWithExplosion(ServerWorld level,
        ...
        if (!level.getGameRules().getBoolean(GameRules.RULE_MOBGRIEFING)
                ...
                || entityBlockPos(creeper).distSqr(pos) > 9.0D) {
            return false;
        }
    ...
    public static boolean canIgnite(CreeperEntity creeper, Vec3d destination,
    ...
    public static boolean opensTowardDestination(ServerWorld level,
                                                ...
                                                BlockPos obstacle,
                                                Vec3d destination) {
        Vec3d direction = destination.subtract(creeper.position())
                .multiply(1.0D, 0.0D, 1.0D);
        ...
        return openFeet && openHead
                && Minecraft115VectorCompat.atCenterOf(beyond).distanceToSqr(destination)
