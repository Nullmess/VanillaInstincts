...
public final class WorldPermissionService {
    ...
    public static boolean setBlock(WorldServer level, @Nullable Entity actor,
        ...
        BlockSnapshot rollbackSnapshot = legacySnapshot(level, pos, flags);
    ...
    private static BlockSnapshot legacySnapshot(WorldServer level, BlockPos pos, int flags) {
        return BlockSnapshot.getBlockSnapshot(level, pos.getX(), pos.getY(), pos.getZ(), flags);
    }
