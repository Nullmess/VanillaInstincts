...
public final class AdaptiveProgressionController {
    ...
    public static void tickHookItem(EntityItem hook, WorldServer level,
        ...
        Entity owner = level.getEntityFromUuid(fr.vanillainstincts.compat.Minecraft18NbtCompat.getUniqueId(data, ANGLER_HOOK_OWNER));
    ...
    private static void castHook(EntityZombie zombie, EntityPlayerMP target,
        ...
        Vec3 origin = zombie.getPositionEyes(1.0F).add(
                fr.vanillainstincts.compat.Minecraft112Compat.scale(zombie.getLookVec(), 0.35D));
        Vec3 aim = fr.vanillainstincts.compat.Minecraft110Compat.boxCenter(target.getEntityBoundingBox()).add(
    ...
    private static void tickActiveHook(EntityZombie zombie, EntityPlayerMP target,
        ...
        Vec3 pull = fr.vanillainstincts.compat.Minecraft110Compat.boxCenter(zombie.getEntityBoundingBox())
    ...
    private static void renderHookLine(EntityZombie zombie, WorldServer level,
        ...
        Vec3 start = Minecraft112Compat.add(zombie.getPositionVector(), 0.0D, 1.35D, 0.0D);
        Vec3 delta = hook.getPositionVector().subtract(start);
    ...
    private static EntityPlayerMP progressionTarget(EntityZombie zombie,
        ...
        Entity entity = level.getEntityFromUuid(fr.vanillainstincts.compat.Minecraft18NbtCompat.getUniqueId(data, TARGET));
    ...
    private static int countLocal(WorldServer level, EntityZombie zombie,
        ...
        return fr.vanillainstincts.compat.Minecraft112Compat.entitiesWithinAABB(level, EntityZombie.class,
                fr.vanillainstincts.compat.Minecraft112Compat.expandBox(zombie.getEntityBoundingBox(), radius),
    ...
    private static EntityItem hookEntity(EntityZombie zombie, WorldServer level) {
        ...
        Entity entity = level.getEntityFromUuid(fr.vanillainstincts.compat.Minecraft18NbtCompat.getUniqueId(data, ANGLER_HOOK_ID));
