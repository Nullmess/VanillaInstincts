...
public final class VanillaInstinctsEventRegistrar {
    ...
    public static void register(IEventBus modBus) {
        ...
        MinecraftForge.EVENT_BUS.addListener(CreatureLifecycleEvents::onEntityTick);
        MinecraftForge.EVENT_BUS.addListener(CreatureLifecycleEvents::onEntityJoinLevel);
        MinecraftForge.EVENT_BUS.addListener(CreatureLifecycleEvents::onEntityLeaveLevel);
        ...
        MinecraftForge.EVENT_BUS.addListener(ServerLifecycleEvents::onLevelUnload);
        ...
        MinecraftForge.EVENT_BUS.addListener(WorldInteractionEvents::onCanPlayerSleep);
        MinecraftForge.EVENT_BUS.addListener(WorldInteractionEvents::onCanContinueSleeping);
        ...
        MinecraftForge.EVENT_BUS.addListener(VillageInteractionEvents::onTradeWithVillager);
        MinecraftForge.EVENT_BUS.addListener(VillageInteractionEvents::onLivingConversion);
        ...
        MinecraftForge.EVENT_BUS.addListener(CombatEvents::onLivingIncomingDamage);
