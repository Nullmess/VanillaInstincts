...
public final class MobPossessionClientEvents {
    ...
    public static void onRenderLivingPre(RenderLivingEvent.Pre<?, ?> event) {
        ...
        if (hideHands) {
            mob.setItemSlot(EntityEquipmentSlot.MAINHAND, ItemStack.EMPTY);
            mob.setItemSlot(EntityEquipmentSlot.OFFHAND, ItemStack.EMPTY);
        }
        if (hideArmor) {
            mob.setItemSlot(EntityEquipmentSlot.HEAD, ItemStack.EMPTY);
            mob.setItemSlot(EntityEquipmentSlot.CHEST, ItemStack.EMPTY);
            mob.setItemSlot(EntityEquipmentSlot.LEGS, ItemStack.EMPTY);
            mob.setItemSlot(EntityEquipmentSlot.FEET, ItemStack.EMPTY);
        }
    }
    ...
    private static void predictLocalMovement(EntityLiving mob, int flags, float yaw,
        ...
        if (creativeControl) {
            ...
            Vec3d right = new Vec3d(-facing.z, 0.0D, facing.x);
