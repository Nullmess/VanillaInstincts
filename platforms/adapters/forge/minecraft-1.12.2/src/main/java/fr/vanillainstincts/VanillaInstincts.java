...
public final class VanillaInstincts {
    ...
    public void init(FMLInitializationEvent event) {
        LOGGER.info("Vanilla Instincts {} ({}) initialised for Forge 1.12.x",
                VERSION, BUILD_ID);
    }
