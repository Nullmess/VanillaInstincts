...
@Mod(modid = VanillaInstincts.MOD_ID, name = "Vanilla Instincts",
        version = VanillaInstincts.VERSION, acceptedMinecraftVersions = "[1.10.2]")
public final class VanillaInstincts {
    public static final String MOD_ID = "vanillainstincts";
    public static final String VERSION = "1.0.0";
    public static final String BUILD_ID = "legacy-1.10.2-port";
    ...
    public void init(FMLInitializationEvent event) {
        LOGGER.info("Vanilla Instincts {} ({}) initialised for Forge 1.10.2",
                VERSION, BUILD_ID);
    }
