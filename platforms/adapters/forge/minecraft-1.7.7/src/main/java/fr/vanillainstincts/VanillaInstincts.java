...
/** Forge 1.7.7 compatibility bootstrap on the Forge 1.7.10 toolchain. */
@Mod(modid = VanillaInstincts.MOD_ID, name = "Vanilla Instincts",
        version = VanillaInstincts.VERSION, acceptedMinecraftVersions = "[1.7.7]")
public final class VanillaInstincts {
    public static final String MOD_ID = "vanillainstincts";
    public static final String VERSION = "1.0.0";
    public static final String BUILD_ID = "legacy-1.7.7-compat";
    ...
    public void init(FMLInitializationEvent event) {
        LOGGER.info("Vanilla Instincts {} ({}) initialised for Minecraft 1.7.7 compatibility profile (Forge 1.7.10 toolchain)",
                VERSION, BUILD_ID);
    }
