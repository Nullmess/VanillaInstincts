...
public final class VanillaInstincts {
    ...
    public void init(FMLInitializationEvent event) {
        LOGGER.info("Vanilla Instincts {} ({}) initialised for Forge 1.8.8",
                VERSION, BUILD_ID);
    }
